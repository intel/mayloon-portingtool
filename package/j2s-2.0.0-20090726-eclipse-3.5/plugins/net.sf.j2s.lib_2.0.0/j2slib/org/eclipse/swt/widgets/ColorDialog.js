...
O$.destroyHandle(this.hText);
this.hText=null;
}if(this.sText!=null){
O$.destroyHandle(this.sText);
this.sText=null;
}if(this.lText!=null){
O$.destroyHandle(this.lText);
this.lText=null;
}if(this.rText!=null){
O$.destroyHandle(this.rText);
this.rText=null;
}if(this.gText!=null){
O$.destroyHandle(this.gText);
this.gText=null;
}if(this.bText!=null){
O$.destroyHandle(this.bText);
this.bText=null;
...
}}this.dialogShell=(function(i$,arg0,arg1,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$1")){
$_H();
...
return $_N($wt.widgets.ColorDialog$1,i$,v$,arg0,arg1);
})(this,this.parent.display,this.style|64|65536,null);
...
this.customButton.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$2")){
$_H();
...
this.b$["$wt.widgets.ColorDialog"].customButton.onclick=null;
this.b$["$wt.widgets.ColorDialog"].configureCustomPanel();
O$.addCSSClass(this.f$.containerHandle.childNodes[0],"color-dialog-custom");
});
c$=$_P();
}
return $_N($wt.widgets.ColorDialog$2,i$,v$);
})(this,$_F("composite",composite,"containerHandle",containerHandle)));
this.okButton.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$3")){
$_H();
...
return $_N($wt.widgets.ColorDialog$3,i$,v$);
})(this,null));
this.cancelButton.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$4")){
$_H();
...
return $_N($wt.widgets.ColorDialog$4,i$,v$);
})(this,null));
...
for(var i=0;i<this.basicColorBoxes.length;i++){
var index=i;
this.basicColorBoxes[i].onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$5")){
$_H();
...
return $_N($wt.widgets.ColorDialog$5,i$,v$);
})(this,$_F("index",index,"colorMap",colorMap,"colorMatrix",colorMatrix)));
}
for(var i=0;i<this.customColorBoxes.length;i++){
var index=i;
this.customColorBoxes[i].onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$6")){
$_H();
...
return $_N($wt.widgets.ColorDialog$6,i$,v$);
})(this,$_F("index",index)));
...
function(){
this.addToCustomButton.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$7")){
$_H();
...
return $_N($wt.widgets.ColorDialog$7,i$,v$);
})(this,null));
var dnd=new $wt.internal.dnd.DragAndDrop();
dnd.addDragListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$8")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
this.originalTop=0;
...
return $_N($wt.widgets.ColorDialog$8,i$,v$);
})(this,null));
dnd.bind(this.lPicker);
this.colorBlock.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$9")){
$_H();
...
return $_N($wt.widgets.ColorDialog$9,i$,v$);
})(this,null));
this.stripBlock.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$10")){
$_H();
...
return $_N($wt.widgets.ColorDialog$10,i$,v$);
})(this,null));
var updateRGBRunnable=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$11")){
$_H();
...
return $_N($wt.widgets.ColorDialog$11,i$,v$);
})(this,null));
var updateHSLRunnable=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ColorDialog$12")){
$_H();
...
return $_N($wt.widgets.ColorDialog$12,i$,v$);
})(this,null));
this.hText.onchange=this.sText.onchange=this.lText.onchange=updateRGBRunnable;
this.rText.onchange=this.gText.onchange=this.bText.onchange=updateHSLRunnable;
this.hText.onkeyup=this.sText.onkeyup=this.lText.onkeyup=updateRGBRunnable;
this.rText.onkeyup=this.gText.onkeyup=this.bText.onkeyup=updateHSLRunnable;
});
$_M(c$,"constrain",
function(el,max){
var textEl=el;

/* http://j2s.sf.net/ */$_L(["$wt.widgets.Item"],"$wt.widgets.CoolItem",["$wt.graphics.Point","$.Rectangle","$wt.internal.browser.OS","$wt.widgets.TypedListener"],function(){
c$=$_C(function(){
this.parent=null;
this.control=null;
this.id=0;
...
$_L(["$wt.widgets.Composite"],"$wt.widgets.CoolBar",["$wt.graphics.Point","$wt.internal.RunnableCompatibility","$wt.internal.browser.OS","$wt.internal.dnd.DragAdapter","$.DragAndDrop","$wt.widgets.Event"],function(){
...
if(!$_D("org.eclipse.swt.widgets.CoolBar$1")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
this.dxx=0;
...
this.y=0;
$_Z(this,arguments);
},$wt.widgets,"CoolBar$1",$wt.internal.dnd.DragAdapter);
$_V(c$,"dragging",
function(e){
var dx=e.deltaX()-this.dxx;
var dLine=this.b$["$wt.widgets.CoolBar"].verticalLineByPixel(this.y+e.deltaY()-this.dyy);
if(dx!=0||dLine!=0){
if(this.b$["$wt.widgets.CoolBar"].moveDelta(this.b$["$wt.widgets.CoolBar"].indexOf(this.f$.item),dx,dLine)){
this.dxx=e.deltaX();
if(dLine!=0){
...
return $_N($wt.widgets.CoolBar$1,i$,v$);
})(this,$_F("item",item)));
dnd.bind(el);
if((item.style&4)!=0){
el=d$.createElement("DIV");
...
item.moreHandle.appendChild(el);
item.moreHandle.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.CoolBar$2")){
$_H();
c$=$_W($wt.widgets,"CoolBar$2",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
e.x=0;
e.y=0;
e.display=this.b$["$wt.widgets.CoolBar"].display;
e.widget=this.f$.item;
e.type=13;
this.f$.item.sendEvent(e);
});
c$=$_P();
}
return $_N($wt.widgets.CoolBar$2,i$,v$);
})(this,$_F("item",item)));
}el=d$.createElement("DIV");
...
}}this.handle.removeChild(this.items[index].handle);

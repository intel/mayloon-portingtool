...
if(!$_D("org.eclipse.swt.widgets.Tree$1")){
$_H();
...
return $_N($wt.widgets.Tree$1,i$,v$);
})(this,null));
});
$_M(c$,"setFocusIndex",
function(index){
...
var ii=item.parentItem;
anchorV.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Tree$2")){
$_H();
c$=$_W($wt.widgets,"Tree$2",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
this.f$.ii.toggleExpandStatus();
});
c$=$_P();
}
return $_N($wt.widgets.Tree$2,i$,v$);
})(this,$_F("ii",ii)));
}}var visible=true;

...
aboutShell.addDisposeListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.About$1")){
$_H();
...
return $_N($wt.widgets.About$1,i$,v$);
})(this,null));
...
java2scriptLabel.setLayoutData(new $wt.layout.GridData(4,16777216,true,false));
...
if(!$_D("org.eclipse.swt.widgets.About$2")){
$_H();
...
return $_N($wt.widgets.About$2,i$,v$);
})(this,null));

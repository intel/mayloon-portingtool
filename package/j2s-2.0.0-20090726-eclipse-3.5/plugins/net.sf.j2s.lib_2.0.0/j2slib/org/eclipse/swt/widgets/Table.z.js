...
this.handle.childNodes[0].removeChild(tmpDiv);
}},"~B");
$_M(c$,"isSelected",
function(){
...
($fz=function(){
this.handle.ondblclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.TableColumn$1")){
$_H();
...
return $_N($wt.widgets.TableColumn$1,i$,v$);
})(this,null));
},$fz.isPrivate=true,$fz));
$_K(c$,
function(parent,style,index){
...
if(!$_D("org.eclipse.swt.widgets.Table$1")){
$_H();
...
return $_N($wt.widgets.Table$1,i$,v$);
})(this,null));
});
...
$_L(["$wt.internal.dnd.DragAdapter"],"$wt.internal.dnd.TableColumnDND",["$wt.graphics.Point","$wt.internal.dnd.DNDUtils"],function(){
c$=$_C(function(){
this.sourceX=0;
this.thumb=null;
$_Z(this,arguments);

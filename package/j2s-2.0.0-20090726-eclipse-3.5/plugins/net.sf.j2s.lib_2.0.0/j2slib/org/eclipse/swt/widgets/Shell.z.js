...
this.textHandle=d;
this.iconHandle=e;
},"$wt.widgets.Shell,~S,$wt.internal.xhtml.Element,$wt.internal.xhtml.Element,$wt.internal.xhtml.Element");
c$=$_P();
$_Y(c$,function(){
...
si.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.TaskBar$1")){
$_H();
...
return $_N($wt.widgets.TaskBar$1,i$,v$);
})(this,null));
...
if(shell!=null){
si.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.TaskBar$2")){
$_H();
c$=$_W($wt.widgets,"TaskBar$2",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.TaskBar$2,i$,v$);
})(this,$_F("shell",shell)));
}this.items[this.items.length]=new $wt.widgets.TaskBar.TaskItem(shell,text,si,div,icon);
...
if(!$_D("org.eclipse.swt.widgets.TaskBar$3")){
$_H();
c$=$_W($wt.widgets,"TaskBar$3",null,Runnable);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.TaskBar$3,i$,v$);
...
sb.appendChild(bb);
this.barEl=bb;
this.barEl.onmouseover=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.TaskBar$4")){
$_H();
...
return $_N($wt.widgets.TaskBar$4,i$,v$);
})(this,null));
this.barEl.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.TaskBar$5")){
$_H();
...
if(!$_D("org.eclipse.swt.widgets.TaskBar$5$6")){
$_H();
c$=$_W($wt.widgets,"TaskBar$5$6",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.TaskBar$5$6,i$,v$);
})(this,null)),500);
}this.b$["$wt.widgets.TaskBar"].bringToTop(-1);
});
c$=$_P();
}
return $_N($wt.widgets.TaskBar$5,i$,v$);
})(this,null));
this.barEl.ondblclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.TaskBar$7")){
$_H();
c$=$_W($wt.widgets,"TaskBar$7",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.TaskBar$7,i$,v$);
})(this,null));
...
O$.destroyHandle(item.iconHandle);
item.iconHandle=null;
}if(item.itemHandle!=null){
O$.destroyHandle(item.itemHandle);
item.itemHandle=null;
}}}
this.items=null;
}});
...
this.handle.style.left=Math.round(Math.floor((d$.body.clientWidth-320)/2))+"px";
...
this.handle.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.NotificationCorner$1")){
$_H();
...
return $_N($wt.widgets.NotificationCorner$1,i$,v$);
})(this,null));
if(this.mouseOver==null){
this.mouseOver=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.NotificationCorner$2")){
$_H();
...
return $_N($wt.widgets.NotificationCorner$2,i$,v$);
})(this,null));
}if(this.mouseClick==null){
this.mouseClick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.NotificationCorner$3")){
$_H();
...
w$.setTimeout($_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.NotificationCorner$3$4")){
$_H();
c$=$_W($wt.widgets,"NotificationCorner$3$4",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.NotificationCorner$3$4,i$,v$);
})(this,null)),500);
}this.b$["$wt.widgets.NotificationCorner"].bringToTop(-1);
});
c$=$_P();
}
return $_N($wt.widgets.NotificationCorner$3,i$,v$);
})(this,null));
}if(this.mouseDoubleClick==null){
this.mouseDoubleClick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.NotificationCorner$5")){
$_H();
c$=$_W($wt.widgets,"NotificationCorner$5",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.NotificationCorner$5,i$,v$);
})(this,null));
}if(this.handle!=null&&this.handle.onmouseover==null){
this.handle.onmouseover=this.mouseOver;
}this.updateEvents();
});
$_M(c$,"updateEvents",
function(){
...
$_M(c$,"bindEvents",
function(cell){
cell.onclick=this.mouseClick;
cell.onmouseover=this.mouseOver;
cell.ondblclick=this.mouseDoubleClick;
},"$wt.internal.xhtml.Element");
$_M(c$,"handleApproaching",
function(){
if(this.handle==null){
...
$_L(["$wt.graphics.Device","$wt.widgets.Tray"],"$wt.widgets.Display",["java.util.Date","$wt.events.SelectionAdapter","$wt.graphics.Color","$.Cursor","$.Font","$.Image","$.Point","$.Rectangle","$wt.internal.ResizeSystem","$.RunnableCompatibility","$wt.internal.browser.OS","$wt.internal.dnd.HTMLEventWrapper","$wt.widgets.Event","$.EventTable","$.MaximizedTitle","$.Monitor","$.NotificationCorner","$.QuickLaunch","$.TaskBar","$.TrayItem"],function(){
c$=$_C(function(){
...
$wt.widgets.Display.bringShellToTop();
...
}this.mouseMoveListener=$_Q((function(i$,v$){
...
function(){
var item=new $wt.widgets.TrayItem($wt.widgets.Display.getTray(),0);
...
continue;}var d=new java.util.Date().getTime();
var c=m.control;
...
c.layout();
}time+=new java.util.Date().getTime()-d;
if(time>200){
idx=0;
if(deferred){
for(var j=0;j<i+1;j++){
...
if($wt.widgets.NotificationCorner.defaultNotificationCorner!=null){
new $wt.widgets.Display().getSystemTray();
var corner=$wt.widgets.NotificationCorner.defaultNotificationCorner;
d$.body.removeChild(corner.handle);
d$.body.appendChild(corner.handle);
...
c$.bringShellToTop=$_M(c$,"bringShellToTop",
function(){
var onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Display$4")){
$_H();
...
return $_N($wt.widgets.Display$4,i$,v$);
})(this,null));
{
if(document.addEventListener){
...
$_M(c$,"hookKeyPress",
($fz=function(){
if(this.handle.onkeypress!=null){
return;
...
if(!$_D("org.eclipse.swt.widgets.Widget$18")){
$_H();
c$=$_W($wt.widgets,"Widget$18",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.Widget$18,i$,v$);
})(this,null));
});
$_M(c$,"hookMouseWheel",
function(){
...
this.handle.style.fontFamily="";
this.handle.style.fontSize="";
this.handle.style.fontWeight="";
this.handle.style.fontStyle="";
this.handle.style.textDecoration="";
return;
...
td="underline";
}}this.handle.style.textDecoration=td;
},"$wt.graphics.Font");
$_M(c$,"setForeground",
function(color){
if(color!=null){
...
}el.oncontextmenu=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Control$2")){
$_H();
...
return $_N($wt.widgets.Control$2,i$,v$);
})(this,null));
},"$wt.widgets.Menu");
$_M(c$,"setRadioFocus",
function(){
...
}this.sbHandle.onscroll=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ScrollBar$1")){
$_H();
...
return $_N($wt.widgets.ScrollBar$1,i$,v$);
})(this,null));
});
...
this.lastClientAreaOnScroll=null;
this.shellMin=null;
this.shellMax=null;
...
return el;
},$fz.isPrivate=true,$fz),"$wt.internal.xhtml.Element,~S");
...
handle.style.filter="";
}},"$wt.internal.xhtml.Element,~B,~B,~B,~B");
...
this.shellFrameDND=(function(i$,v$){
...
dnd.addDragListener(this.shellFrameDND);
dnd.bind(this.handle);
}this.contentHandle.onkeydown=$_Q((function(i$,v$){
...
this.lastClientAreaOnScroll=node.onscroll;
...
node.onscroll=this.lastClientAreaOnScroll;
}}},"~B");
$_M(c$,"setMenuBar",
function(menu){
...
$_H();
c$=$_W($wt.widgets,"Decorations$7$8",null,Runnable);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.Decorations$7$8,i$,v$);
})(this,null));
});
c$=$_P();
}
...
$_H();
c$=$_W($wt.widgets,"Decorations$10",$wt.internal.RunnableCompatibility);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.Decorations$10,i$,v$);
})(this,null));
...
w$.setTimeout($_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Decorations$11")){
$_H();
c$=$_W($wt.widgets,"Decorations$11",null,Runnable);
$_V(c$,"run",
function(){
...
return $_N($wt.widgets.Decorations$11,i$,v$);
})(this,null)),50);
}}},"~S");
$_V(c$,"setVisible",
function(visible){
...
taskBar.handleApproaching();
w$.setTimeout($_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Shell$1")){
$_H();
...
return $_N($wt.widgets.Shell$1,i$,v$);
})(this,null)),50);
taskBar.setMinimized(false);
taskBar.updateLastModified();
}});
...
w$.setTimeout($_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Shell$2")){
$_H();
...
return $_N($wt.widgets.Shell$2,i$,v$);
})(this,null)),50);
...
$_L(null,"$wt.widgets.Dialog",["$wt.widgets.Display"],function(){
c$=$_C(function(){
this.style=0;
this.parent=null;
this.title=null;

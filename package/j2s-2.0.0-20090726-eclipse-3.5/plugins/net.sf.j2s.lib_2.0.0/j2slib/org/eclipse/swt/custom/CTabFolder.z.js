/* http://j2s.sf.net/ */$_L(["$wt.events.TypedEvent"],"$wt.custom.CTabFolderEvent",null,function(){
c$=$_C(function(){
this.item=null;
this.doit=false;
this.x=0;
...
$_L(["$wt.widgets.Item","$wt.graphics.Rectangle"],"$wt.custom.CTabItem",["$wt.custom.CTabFolder","$wt.graphics.Color","$wt.internal.browser.OS"],function(){
c$=$_C(function(){
this.parent=null;
this.x=0;
this.y=0;
...
s.backgroundColor=this.parent.borderColor.getCSSHandle();
...
if((this.getStyle()&262144)!=0){
var height=this.borderTop+this.tabHeight+this.highlight_header+this.borderBottom;
if(size.y>height){
}}}if(this.borderLeft>0){
...
if((style&8388608)!=0&&(style&2048)==0)return;
var x1=this.borderLeft-1;
var x2=size.x-this.borderRight;
var y1=this.onBottom?size.y-this.borderBottom-this.highlight_header-1:this.borderTop+this.highlight_header;
var y2=this.onBottom?size.y-this.borderBottom:this.borderTop;
if(this.borderLeft>0&&this.onBottom)y2-=1;
...
if(!$_D("org.eclipse.swt.custom.CTabFolder$2")){
$_H();
...
return $_N($wt.custom.CTabFolder$2,i$,v$);
})(this,null));
accessible.addAccessibleControlListener((function(i$,v$){
if(!$_D("org.eclipse.swt.custom.CTabFolder$3")){
$_H();
...
return $_N($wt.custom.CTabFolder$3,i$,v$);
})(this,null));
this.addListener(13,(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.CTabFolder$4")){
$_H();
...
return $_N($wt.custom.CTabFolder$4,i$,v$);
})(this,$_F("accessible",accessible)));
this.addListener(15,(function(i$,v$){
if(!$_D("org.eclipse.swt.custom.CTabFolder$5")){
$_H();
...
return $_N($wt.custom.CTabFolder$5,i$,v$);
})(this,$_F("accessible",accessible)));
});
$_M(c$,"onKeyDown",
function(event){
...
System.out.println(event.button+" button.");
if(event.button!=1)return;
...
if(!$_D("org.eclipse.swt.custom.CTabFolder$6")){
$_H();
...
return $_N($wt.custom.CTabFolder$6,i$,v$);
})(this,null));
}
var x=rect.x;

...
if(!$_D("org.eclipse.swt.widgets.ToolItem$1")){
$_H();
...
return $_N($wt.widgets.ToolItem$1,i$,v$);
})(this,null));
this.handle.onclick=this.handle.ondblclick=eventHandler;
if((this.style&2)==0){
if(this.dropDownEl!=null){
var arrow=this.dropDownEl.childNodes[0];
this.handle.onmousedown=arrow.onmousedown=this.dropDownEl.onmousedown=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ToolItem$2")){
$_H();
...
return $_N($wt.widgets.ToolItem$2,i$,v$);
})(this,null));
this.handle.onmouseout=this.handle.onmouseup=arrow.onmouseout=arrow.onmouseup=this.dropDownEl.onmouseup=this.dropDownEl.onmouseout=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ToolItem$3")){
$_H();
...
return $_N($wt.widgets.ToolItem$3,i$,v$);
})(this,null));
arrow.onclick=this.dropDownEl.onclick=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ToolItem$4")){
$_H();
...
return $_N($wt.widgets.ToolItem$4,i$,v$);
})(this,null));
}else{
this.handle.onmousedown=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ToolItem$5")){
$_H();
...
return $_N($wt.widgets.ToolItem$5,i$,v$);
})(this,null));
this.handle.onmouseout=this.handle.onmouseup=$_Q((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.ToolItem$6")){
$_H();
...
return $_N($wt.widgets.ToolItem$6,i$,v$);
})(this,null));
}}});

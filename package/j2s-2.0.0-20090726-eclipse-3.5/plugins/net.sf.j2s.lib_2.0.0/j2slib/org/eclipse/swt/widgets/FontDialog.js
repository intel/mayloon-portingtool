...
okButton.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$1")){
$_H();
...
return $_N($wt.widgets.FontDialog$1,i$,v$);
})(this,null));
var cancelButton=new $wt.widgets.Button(buttonsPanel,8);
cancelButton.setText("Cancel");
cancelButton.setLayoutData(gridData);
cancelButton.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$2")){
$_H();
...
return $_N($wt.widgets.FontDialog$2,i$,v$);
})(this,null));
this.familyText=new $wt.widgets.Text(fontPicker,2052);
this.familyText.setLayoutData(new $wt.layout.GridData(768));
this.familyText.addModifyListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$3")){
$_H();
...
return $_N($wt.widgets.FontDialog$3,i$,v$);
})(this,null));
this.styleText=new $wt.widgets.Text(fontPicker,2052);
this.styleText.setLayoutData(new $wt.layout.GridData(768));
this.styleText.addModifyListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$4")){
$_H();
...
return $_N($wt.widgets.FontDialog$4,i$,v$);
})(this,null));
this.sizeText=new $wt.widgets.Text(fontPicker,2052);
var gd=new $wt.layout.GridData();
gd.widthHint=48;
this.sizeText.setLayoutData(gd);
this.sizeText.addModifyListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$5")){
$_H();
...
return $_N($wt.widgets.FontDialog$5,i$,v$);
})(this,null));
this.familyList=new $wt.widgets.List(fontPicker,2624);
this.familyList.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$6")){
$_H();
...
return $_N($wt.widgets.FontDialog$6,i$,v$);
})(this,null));
...
this.styleList.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$7")){
$_H();
...
return $_N($wt.widgets.FontDialog$7,i$,v$);
})(this,null));
...
this.sizeList.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$8")){
$_H();
...
return $_N($wt.widgets.FontDialog$8,i$,v$);
})(this,null));
gdList=new $wt.layout.GridData(1808);
gdList.heightHint=80;
...
this.strikeButton.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$9")){
$_H();
...
return $_N($wt.widgets.FontDialog$9,i$,v$);
})(this,null));
this.underlineButton=new $wt.widgets.Button(effectGroup,32);
this.underlineButton.setText("&Underline");
this.underlineButton.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$10")){
$_H();
...
return $_N($wt.widgets.FontDialog$10,i$,v$);
})(this,null));
...
this.colorCombo.addSelectionListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.FontDialog$11")){
$_H();
...
return $_N($wt.widgets.FontDialog$11,i$,v$);
})(this,null));
var idx=0;

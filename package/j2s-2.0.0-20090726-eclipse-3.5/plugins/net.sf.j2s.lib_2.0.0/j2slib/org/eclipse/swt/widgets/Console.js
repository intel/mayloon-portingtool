...
$wt.widgets.Console.console.addShellListener((function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Console$1")){
$_H();
...
return $_N($wt.widgets.Console$1,i$,v$);
})(this,null));
...
$wt.widgets.Console.console.getDisplay().timerExec(50,(function(i$,v$){
if(!$_D("org.eclipse.swt.widgets.Console$2")){
$_H();
...
return $_N($wt.widgets.Console$2,i$,v$);
})(this,null));

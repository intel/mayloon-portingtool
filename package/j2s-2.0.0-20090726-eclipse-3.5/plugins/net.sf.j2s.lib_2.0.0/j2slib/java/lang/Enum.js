...
function(enumType){
try{
var values=java.security.AccessController.doPrivileged((function(i$,v$){
if(!$_D("java.lang.Enum$1")){
$_H();
c$=$_W(java.lang,"Enum$1",null,java.security.PrivilegedExceptionAction);
$_V(c$,"run",
function(){
...
return $_N(Enum$1,i$,v$);
})(this,$_F("enumType",enumType)));

...
$_V(c$,"iterator",
function(){
return new java.util.LinkedHashMap.LinkedHashIterator((function(i$,v$){
if(!$_D("java.util.LinkedHashMap.LinkedHashMapEntrySet$1")){
$_H();
...
return $_N(java.util.LinkedHashMap.LinkedHashMapEntrySet$1,i$,v$);
})(this,null),this.hashMap());
});
c$=$_P();
$_H();
c$=$_C(function(){
...
if(!$_D("java.util.LinkedHashMap$1")){
$_H();
...
function(){
return new java.util.LinkedHashMap.LinkedHashIterator((function(i$,v$){
if(!$_D("java.util.LinkedHashMap$1$2")){
$_H();
c$=$_W(java.util,"LinkedHashMap$1$2",null,java.util.MapEntry.Type);
$_V(c$,"get",
function(entry){
return entry.key;
},"java.util.MapEntry");
...
return $_N(java.util.LinkedHashMap$1$2,i$,v$);
})(this,null),this.b$["java.util.LinkedHashMap"]);
});
c$=$_P();
}
return $_N(java.util.LinkedHashMap$1,i$,v$);
})(this,null);
}return this.$keySet;
});
$_V(c$,"values",
...
if(!$_D("java.util.LinkedHashMap$3")){
$_H();
c$=$_W(java.util,"LinkedHashMap$3",java.util.AbstractCollection);
$_V(c$,"contains",
function(object){
...
function(){
return new java.util.LinkedHashMap.LinkedHashIterator((function(i$,v$){
if(!$_D("java.util.LinkedHashMap$3$4")){
$_H();
c$=$_W(java.util,"LinkedHashMap$3$4",null,java.util.MapEntry.Type);
$_V(c$,"get",
function(entry){
return entry.value;
},"java.util.MapEntry");
...
return $_N(java.util.LinkedHashMap$3$4,i$,v$);
})(this,null),this.b$["java.util.LinkedHashMap"]);
});
c$=$_P();
}
return $_N(java.util.LinkedHashMap$3,i$,v$);
})(this,null);

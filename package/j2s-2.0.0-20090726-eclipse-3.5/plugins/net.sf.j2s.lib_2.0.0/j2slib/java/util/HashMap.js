...
$_V(c$,"iterator",
function(){
return new java.util.HashMap.HashMapIterator((function(i$,v$){
if(!$_D("java.util.HashMap.HashMapEntrySet$1")){
$_H();
...
return $_N(java.util.HashMap.HashMapEntrySet$1,i$,v$);
...
function(){
return new java.util.HashMap.HashMapIterator((function(i$,v$){
if(!$_D("java.util.HashMap$1$2")){
$_H();
c$=$_W(java.util,"HashMap$1$2",null,java.util.MapEntry.Type);
$_V(c$,"get",
function(entry){
return entry.key;
},"java.util.MapEntry");
...
return $_N(java.util.HashMap$1$2,i$,v$);
})(this,null),this.b$["java.util.HashMap"]);
});
c$=$_P();
}
return $_N(java.util.HashMap$1,i$,v$);
})(this,null);
}return this.$keySet;
});
$_V(c$,"put",
...
if(!$_D("java.util.HashMap$3")){
$_H();
c$=$_W(java.util,"HashMap$3",java.util.AbstractCollection);
$_V(c$,"contains",
function(object){
...
function(){
return new java.util.HashMap.HashMapIterator((function(i$,v$){
if(!$_D("java.util.HashMap$3$4")){
$_H();
c$=$_W(java.util,"HashMap$3$4",null,java.util.MapEntry.Type);
$_V(c$,"get",
function(entry){
return entry.value;
},"java.util.MapEntry");
...
return $_N(java.util.HashMap$3$4,i$,v$);
})(this,null),this.b$["java.util.HashMap"]);
});
c$=$_P();
}
return $_N(java.util.HashMap$3,i$,v$);
})(this,null);

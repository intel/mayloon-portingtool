...
$_V(c$,"iterator",
function(){
return new java.util.IdentityHashMap.IdentityHashMapIterator((function(i$,v$){
if(!$_D("java.util.IdentityHashMap.IdentityHashMapEntrySet$1")){
$_H();
...
return $_N(java.util.IdentityHashMap.IdentityHashMapEntrySet$1,i$,v$);
})(this,null),this.associatedMap);
});
c$=$_P();
$_K(c$,
function(){
...
if(!$_D("java.util.IdentityHashMap$1")){
$_H();
...
function(){
return new java.util.IdentityHashMap.IdentityHashMapIterator((function(i$,v$){
if(!$_D("java.util.IdentityHashMap$1$2")){
$_H();
c$=$_W(java.util,"IdentityHashMap$1$2",null,java.util.MapEntry.Type);
$_V(c$,"get",
function(entry){
return entry.key;
},"java.util.MapEntry");
...
return $_N(java.util.IdentityHashMap$1$2,i$,v$);
})(this,null),this.b$["java.util.IdentityHashMap"]);
});
c$=$_P();
}
return $_N(java.util.IdentityHashMap$1,i$,v$);
})(this,null);
}return this.$keySet;
});
$_V(c$,"values",
...
this.valuesCollection=(function(i$,v$){
if(!$_D("java.util.IdentityHashMap$3")){
$_H();
c$=$_W(java.util,"IdentityHashMap$3",java.util.AbstractCollection);
$_V(c$,"contains",
function(object){
...
function(){
return new java.util.IdentityHashMap.IdentityHashMapIterator((function(i$,v$){
if(!$_D("java.util.IdentityHashMap$3$4")){
$_H();
c$=$_W(java.util,"IdentityHashMap$3$4",null,java.util.MapEntry.Type);
$_V(c$,"get",
function(entry){
return entry.value;
},"java.util.MapEntry");
...
return $_N(java.util.IdentityHashMap$3$4,i$,v$);
})(this,null),this.b$["java.util.IdentityHashMap"]);
});
$_V(c$,"remove",
function(object){
...
return $_N(java.util.IdentityHashMap$3,i$,v$);
})(this,null);
...
"DEFAULT_MAX_SIZE",21,
"loadFactor",7500);
c$.NULL_OBJECT=c$.prototype.NULL_OBJECT=new Object();
});

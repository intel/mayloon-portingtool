...
function(){
return(function(i$,v$){
if(!$_D("java.util.Collections.SingletonMap$1")){
$_H();
...
function(){
return(function(i$,v$){
if(!$_D("java.util.Collections.SingletonMap$1$2")){
$_H();
c$=$_C(function(){
$_B(this,arguments);
this.$hasNext=true;
$_Z(this,arguments);
},java.util.Collections,"SingletonMap$1$2",null,java.util.Iterator);
$_V(c$,"hasNext",
function(){
return this.$hasNext;
});
...
this.$hasNext=false;
return(function(i$,v$){
if(!$_D("java.util.Collections.SingletonMap$1$2$3")){
$_H();
c$=$_W(java.util.Collections,"SingletonMap$1$2$3",null,java.util.Map.Entry);
$_V(c$,"equals",
function(a){
...
return $_N(java.util.Collections.SingletonMap$1$2$3,i$,v$);
})(this,null);
}throw new java.util.NoSuchElementException();
});
$_V(c$,"remove",
...
return $_N(java.util.Collections.SingletonMap$1$2,i$,v$);
})(this,null);
});
c$=$_P();
}
return $_N(java.util.Collections.SingletonMap$1,i$,v$);
})(this,null);
});
c$=$_P();
$_H();

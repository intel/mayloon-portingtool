...
function(request){
var instance=net.sf.j2s.ajax.SimpleSerializable.parseInstance(request,(function(i$,v$){
if(!$_D("net.sf.j2s.ajax.SimpleRPCHttpServlet$1")){
$_H();
...
return $_N(net.sf.j2s.ajax.SimpleRPCHttpServlet$1,i$,v$);
})(this,null));
...
var serialize=runnable.serialize((function(i$,v$){
if(!$_D("net.sf.j2s.ajax.SimpleRPCHttpServlet$2")){
$_H();
...
return $_N(net.sf.j2s.ajax.SimpleRPCHttpServlet$2,i$,v$);
})(this,$_F("diffs",diffs)));
...
var diffs=this.compareDiffs(runnable,clonedRunnable);
var serialize=runnable.serialize((function(i$,v$){
if(!$_D("net.sf.j2s.ajax.SimpleRPCHttpServlet$3")){
$_H();
...
return $_N(net.sf.j2s.ajax.SimpleRPCHttpServlet$3,i$,v$);
})(this,$_F("diffs",diffs)));
resp.setHeader("Pragma","no-cache");
resp.setHeader("Cache-Control","no-cache");
resp.setDateHeader("Expires",0);

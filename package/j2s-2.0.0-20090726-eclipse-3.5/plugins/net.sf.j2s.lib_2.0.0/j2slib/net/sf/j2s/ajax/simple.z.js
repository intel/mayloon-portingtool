...
g.idSet["h"+rnd]=window.setTimeout(fun,30000);
},"~S,~S,~S,~S");
...
$_J("net.sf.j2s.ajax");
$_L(["net.sf.j2s.ajax.SimpleRPCRunnable"],"net.sf.j2s.ajax.SimplePipeRunnable",["net.sf.j2s.ajax.SimpleSerializable"],function(){
c$=$_C(function(){
this.pipeKey=null;
...
"TRIVIAL",1);
$_J("net.sf.j2s.ajax");
$_L(null,"net.sf.j2s.ajax.SimplePipeHelper",["java.util.Collections","$.HashMap"],function(){
...
$_J("net.sf.j2s.ajax");
$_L(["net.sf.j2s.ajax.SimplePipeRunnable"],"net.sf.j2s.ajax.CompoundPipeRunnable",["net.sf.j2s.ajax.SimpleSerializable"],function(){
c$=$_C(function(){
this.pipes=null;
this.status=0;
this.id=null;
...
return true;
}if(this.status==3&&System.currentTimeMillis()-this.lastSetup<30000){
return true;

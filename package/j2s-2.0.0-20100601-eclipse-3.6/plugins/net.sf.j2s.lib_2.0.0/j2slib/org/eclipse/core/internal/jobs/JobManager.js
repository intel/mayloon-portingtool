...
Clazz.load (["org.eclipse.core.runtime.jobs.IJobManager", "java.lang.Boolean", "org.eclipse.core.internal.jobs.ImplicitJobs", "$.JobListeners", "$.LockManager", "org.eclipse.core.internal.runtime.InternalPlatform", "org.eclipse.core.runtime.jobs.ISchedulingRule"], "org.eclipse.core.internal.jobs.JobManager", ["java.lang.IllegalStateException", "$.InterruptedException", "$.StringBuffer", "$.Thread", "java.text.FieldPosition", "$.SimpleDateFormat", "java.util.ArrayList", "$.Collections", "$.Date", "$.HashSet", "org.eclipse.core.internal.jobs.JobQueue", "$.JobStatus", "$.Semaphore", "$.WorkerPool", "org.eclipse.core.internal.runtime.Messages", "$.Policy", "org.eclipse.core.runtime.NullProgressMonitor", "$.OperationCanceledException", "$.Status", "org.eclipse.core.runtime.jobs.Job", "$.JobChangeAdapter", "org.eclipse.osgi.util.NLS"], function () {
...
listener = ((Clazz.isClassDefined ("org.eclipse.core.internal.jobs.JobManager$2") ? 0 : org.eclipse.core.internal.jobs.JobManager.$JobManager$2$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.jobs.JobManager$2, this, Clazz.cloneFinals ("barrier", barrier)));
...
listener = ((Clazz.isClassDefined ("org.eclipse.core.internal.jobs.JobManager$3") ? 0 : org.eclipse.core.internal.jobs.JobManager.$JobManager$3$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.jobs.JobManager$3, this, Clazz.cloneFinals ("jobs", jobs, "family", family)));
...
c$.$JobManager$3$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (org.eclipse.core.internal.jobs, "JobManager$3", org.eclipse.core.runtime.jobs.JobChangeAdapter);
Clazz.overrideMethod (c$, "done", 
function (event) {
...
c$.$JobManager$1$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (org.eclipse.core.internal.jobs, "JobManager$1", null, org.eclipse.core.runtime.jobs.ISchedulingRule);
...
Clazz.defineStatics (c$,
"instance", null);
c$.nullRule = c$.prototype.nullRule = ((Clazz.isClassDefined ("org.eclipse.core.internal.jobs.JobManager$1") ? 0 : org.eclipse.core.internal.jobs.JobManager.$JobManager$1$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.jobs.JobManager$1, this, null));
});

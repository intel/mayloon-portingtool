...
this.policyConstantGeneralIsBetter = ((Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentTypeCatalog$1") ? 0 : org.eclipse.core.internal.content.ContentTypeCatalog.$ContentTypeCatalog$1$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.content.ContentTypeCatalog$1, this, null));
this.policyConstantSpecificIsBetter = ((Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentTypeCatalog$2") ? 0 : org.eclipse.core.internal.content.ContentTypeCatalog.$ContentTypeCatalog$2$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.content.ContentTypeCatalog$2, this, null));
this.policyGeneralIsBetter = ((Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentTypeCatalog$3") ? 0 : org.eclipse.core.internal.content.ContentTypeCatalog.$ContentTypeCatalog$3$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.content.ContentTypeCatalog$3, this, null));
this.policyLexicographical = ((Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentTypeCatalog$4") ? 0 : org.eclipse.core.internal.content.ContentTypeCatalog.$ContentTypeCatalog$4$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.content.ContentTypeCatalog$4, this, null));
this.policySpecificIsBetter = ((Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentTypeCatalog$5") ? 0 : org.eclipse.core.internal.content.ContentTypeCatalog.$ContentTypeCatalog$5$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.content.ContentTypeCatalog$5, this, null));
});
...
org.eclipse.core.runtime.Platform.run (((Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentTypeCatalog$6") ? 0 : org.eclipse.core.internal.content.ContentTypeCatalog.$ContentTypeCatalog$6$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.content.ContentTypeCatalog$6, this, Clazz.cloneFinals ("result", result, "policy", policy, "candidates", candidates, "fileName", fileName, "contents", contents))));
return result[0];
...
var root = i.next ();
this.internalAccept (((Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentTypeCatalog$7") ? 0 : org.eclipse.core.internal.content.ContentTypeCatalog.$ContentTypeCatalog$7$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.content.ContentTypeCatalog$7, this, Clazz.cloneFinals ("root", root, "context", context, "fileSpecText", fileSpecText, "fileSpecType", fileSpecType, "existing", existing, "destination", destination))), root);
}
return destination;
}, $fz.isPrivate = true, $fz), "org.eclipse.core.runtime.preferences.IScopeContext,java.util.Collection,java.util.Collection,~S,~N");
c$.$ContentTypeCatalog$1$ = function () {
Clazz.pu$h ();
...
c$.$ContentTypeCatalog$2$ = function () {
Clazz.pu$h ();
...
c$.$ContentTypeCatalog$3$ = function () {
Clazz.pu$h ();
...
c$.$ContentTypeCatalog$4$ = function () {
Clazz.pu$h ();
...
c$.$ContentTypeCatalog$5$ = function () {
Clazz.pu$h ();
...
c$.$ContentTypeCatalog$6$ = function () {
Clazz.pu$h ();
...
c$.$ContentTypeCatalog$7$ = function () {
Clazz.pu$h ();

...
Clazz.load (["org.eclipse.core.internal.content.IContentTypeInfo", "org.eclipse.core.runtime.content.IContentDescriber", "$.IContentType", "$.ITextContentDescriber"], "org.eclipse.core.internal.content.ContentType", ["java.lang.IllegalArgumentException", "$.UnsupportedOperationException", "java.util.ArrayList", "org.eclipse.core.internal.content.ContentDescription", "$.ContentTypeManager", "$.ContentTypeSettings", "$.DefaultDescription", "$.FileSpec", "$.Util", "org.eclipse.core.internal.runtime.InternalPlatform", "$.Messages", "$.Policy", "org.eclipse.core.runtime.CoreException", "$.Status", "org.eclipse.core.runtime.content.IContentDescription", "org.eclipse.osgi.util.NLS"], function () {
c$ = Clazz.decorateAsClass (function () {
if (!Clazz.isClassDefined ("org.eclipse.core.internal.content.ContentType.InvalidDescriber")) {
org.eclipse.core.internal.content.ContentType.$ContentType$InvalidDescriber$ ();
}
...
c$.$ContentType$InvalidDescriber$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {

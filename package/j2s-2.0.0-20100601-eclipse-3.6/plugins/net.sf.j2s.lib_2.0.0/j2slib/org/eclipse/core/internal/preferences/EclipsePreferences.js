...
var job = ((Clazz.isClassDefined ("org.eclipse.core.internal.preferences.EclipsePreferences$1") ? 0 : org.eclipse.core.internal.preferences.EclipsePreferences.$EclipsePreferences$1$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.preferences.EclipsePreferences$1, this, Clazz.cloneFinals ("added", added, "listener", listener, "event", event)));
...
for (var i = 0; i < listeners.length; i++) {
var listener = listeners[i];
var job = ((Clazz.isClassDefined ("org.eclipse.core.internal.preferences.EclipsePreferences$2") ? 0 : org.eclipse.core.internal.preferences.EclipsePreferences.$EclipsePreferences$2$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.preferences.EclipsePreferences$2, this, Clazz.cloneFinals ("listener", listener, "event", event)));
org.eclipse.core.runtime.Platform.run (job);
}
}, "~S,~O,~O");
...
var visitor = ((Clazz.isClassDefined ("org.eclipse.core.internal.preferences.EclipsePreferences$3") ? 0 : org.eclipse.core.internal.preferences.EclipsePreferences.$EclipsePreferences$3$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.preferences.EclipsePreferences$3, this, Clazz.cloneFinals ("buffer", buffer)));
try {
this.accept (visitor);
} catch (e) {
if (Clazz.instanceOf (e, org.osgi.service.prefs.BackingStoreException)) {
...
c$.$EclipsePreferences$1$ = function () {
Clazz.pu$h ();
...
c$.$EclipsePreferences$2$ = function () {
Clazz.pu$h ();
...
c$.$EclipsePreferences$3$ = function () {
Clazz.pu$h ();

...
Clazz.load (["org.eclipse.jface.viewers.CellEditor"], "org.eclipse.jface.viewers.TextCellEditor", ["java.text.MessageFormat", "$wt.events.FocusAdapter", "$.KeyAdapter", "$.ModifyListener", "$.MouseAdapter", "$.SelectionAdapter", "$.TraverseListener", "$wt.widgets.Text"], function () {
...
this.text.addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TextCellEditor$1") ? 0 : org.eclipse.jface.viewers.TextCellEditor.$TextCellEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TextCellEditor$1, this, null)));
this.text.addKeyListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TextCellEditor$2") ? 0 : org.eclipse.jface.viewers.TextCellEditor.$TextCellEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TextCellEditor$2, this, null)));
this.text.addTraverseListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TextCellEditor$3") ? 0 : org.eclipse.jface.viewers.TextCellEditor.$TextCellEditor$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TextCellEditor$3, this, null)));
this.text.addMouseListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TextCellEditor$4") ? 0 : org.eclipse.jface.viewers.TextCellEditor.$TextCellEditor$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TextCellEditor$4, this, null)));
this.text.addFocusListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TextCellEditor$5") ? 0 : org.eclipse.jface.viewers.TextCellEditor.$TextCellEditor$5$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TextCellEditor$5, this, null)));
...
this.modifyListener = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.TextCellEditor$6") ? 0 : org.eclipse.jface.viewers.TextCellEditor.$TextCellEditor$6$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TextCellEditor$6, this, null));

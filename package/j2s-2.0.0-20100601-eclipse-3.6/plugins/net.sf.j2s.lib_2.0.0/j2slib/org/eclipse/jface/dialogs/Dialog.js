...
button.addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.dialogs.Dialog$2") ? 0 : org.eclipse.jface.dialogs.Dialog.$Dialog$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.dialogs.Dialog$2, this, null)));
if (defaultButton) {
...
c$.$Dialog$2$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (org.eclipse.jface.dialogs, "Dialog$2", $wt.events.SelectionAdapter);
...
c$.$Dialog$1$ = function () {
Clazz.pu$h ();
c$ = Clazz.declareAnonymous (org.eclipse.jface.dialogs, "Dialog$1", null, org.eclipse.jface.dialogs.IDialogBlockedHandler);
...
c$.blockedHandler = c$.prototype.blockedHandler = ((Clazz.isClassDefined ("org.eclipse.jface.dialogs.Dialog$1") ? 0 : org.eclipse.jface.dialogs.Dialog.$Dialog$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.dialogs.Dialog$1, this, null));
});

...
if (this.parent == null) {
this.$overrides = ((Clazz.isClassDefined ("org.eclipse.jface.action.MenuManager$1") ? 0 : org.eclipse.jface.action.MenuManager.$MenuManager$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.MenuManager$1, this, null));
} else {
...
($fz = function () {
this.menu.addMenuListener (((Clazz.isClassDefined ("org.eclipse.jface.action.MenuManager$2") ? 0 : org.eclipse.jface.action.MenuManager.$MenuManager$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.MenuManager$2, this, null)));
}, $fz.isPrivate = true, $fz));

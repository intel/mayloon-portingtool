...
Clazz.load (["org.eclipse.jface.viewers.StructuredViewer", "java.util.ArrayList"], "org.eclipse.jface.viewers.AbstractListViewer", null, function () {
...
function (elements) {
this.assertElementsNotNull (elements);
this.preservingSelection (((Clazz.isClassDefined ("org.eclipse.jface.viewers.AbstractListViewer$1") ? 0 : org.eclipse.jface.viewers.AbstractListViewer.$AbstractListViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.AbstractListViewer$1, this, Clazz.cloneFinals ("elements", elements))));
}, "~A");
Clazz.defineMethod (c$, "remove", 
function (element) {
this.remove ([element]);
...
c$.$AbstractListViewer$1$ = function () {
Clazz.pu$h ();

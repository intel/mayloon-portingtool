...
this.actionTextListener = ((Clazz.isClassDefined ("org.eclipse.jface.action.ActionContributionItem$1") ? 0 : org.eclipse.jface.action.ActionContributionItem.$ActionContributionItem$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.ActionContributionItem$1, this, null));
this.propertyListener = ((Clazz.isClassDefined ("org.eclipse.jface.action.ActionContributionItem$2") ? 0 : org.eclipse.jface.action.ActionContributionItem.$ActionContributionItem$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.ActionContributionItem$2, this, null));
});
...
display.asyncExec (((Clazz.isClassDefined ("org.eclipse.jface.action.ActionContributionItem$3") ? 0 : org.eclipse.jface.action.ActionContributionItem.$ActionContributionItem$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.ActionContributionItem$3, this, Clazz.cloneFinals ("e", e))));
...
this.buttonListener = ((Clazz.isClassDefined ("org.eclipse.jface.action.ActionContributionItem$4") ? 0 : org.eclipse.jface.action.ActionContributionItem.$ActionContributionItem$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.ActionContributionItem$4, this, null));
}return this.buttonListener;
}, $fz.isPrivate = true, $fz));
Clazz.defineMethod (c$, "getMenuItemListener", 
($fz = function () {
if (this.menuItemListener == null) {
this.menuItemListener = ((Clazz.isClassDefined ("org.eclipse.jface.action.ActionContributionItem$5") ? 0 : org.eclipse.jface.action.ActionContributionItem.$ActionContributionItem$5$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.ActionContributionItem$5, this, null));
...
this.toolItemListener = ((Clazz.isClassDefined ("org.eclipse.jface.action.ActionContributionItem$6") ? 0 : org.eclipse.jface.action.ActionContributionItem.$ActionContributionItem$6$ ()), Clazz.innerTypeInstance (org.eclipse.jface.action.ActionContributionItem$6, this, null));
...
c$.$ActionContributionItem$1$ = function () {
Clazz.pu$h ();
...
c$.$ActionContributionItem$2$ = function () {
Clazz.pu$h ();
...
c$.$ActionContributionItem$3$ = function () {
Clazz.pu$h ();
...
c$.$ActionContributionItem$4$ = function () {
Clazz.pu$h ();
...
c$.$ActionContributionItem$5$ = function () {
Clazz.pu$h ();
...
c$.$ActionContributionItem$6$ = function () {
Clazz.pu$h ();

...
Clazz.load (["org.eclipse.jface.preference.FieldEditor"], "org.eclipse.jface.preference.ListEditor", ["org.eclipse.jface.resource.JFaceResources", "$wt.events.DisposeListener", "$.SelectionAdapter", "$wt.layout.GridData", "$.GridLayout", "$wt.widgets.Button", "$.Composite", "$.List"], function () {
...
function () {
this.selectionListener = ((Clazz.isClassDefined ("org.eclipse.jface.preference.ListEditor$1") ? 0 : org.eclipse.jface.preference.ListEditor.$ListEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.ListEditor$1, this, null));
});
...
this.buttonBox.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.ListEditor$2") ? 0 : org.eclipse.jface.preference.ListEditor.$ListEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.ListEditor$2, this, null)));
} else {
...
this.list.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.ListEditor$3") ? 0 : org.eclipse.jface.preference.ListEditor.$ListEditor$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.ListEditor$3, this, null)));
} else {

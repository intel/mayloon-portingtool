...
function (event) {
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.util.DelegatingDragAdapter$1") ? 0 : org.eclipse.jface.util.DelegatingDragAdapter.$DelegatingDragAdapter$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.util.DelegatingDragAdapter$1, this, Clazz.cloneFinals ("event", event))));
this.currentListener = null;
...
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.util.DelegatingDragAdapter$2") ? 0 : org.eclipse.jface.util.DelegatingDragAdapter.$DelegatingDragAdapter$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.util.DelegatingDragAdapter$2, this, Clazz.cloneFinals ("event", event))));
}}, "$wt.dnd.DragSourceEvent");
...
event.doit = true;
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.util.DelegatingDragAdapter$3") ? 0 : org.eclipse.jface.util.DelegatingDragAdapter.$DelegatingDragAdapter$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.util.DelegatingDragAdapter$3, this, Clazz.cloneFinals ("listener", listener, "event", event))));
if (event.doit) {
...
c$.$DelegatingDragAdapter$1$ = function () {
Clazz.pu$h ();
...
c$.$DelegatingDragAdapter$2$ = function () {
Clazz.pu$h ();
...
c$.$DelegatingDragAdapter$3$ = function () {
Clazz.pu$h ();

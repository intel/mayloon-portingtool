...
Clazz.load (["org.eclipse.jface.preference.FieldEditor"], "org.eclipse.jface.preference.StringFieldEditor", ["org.eclipse.jface.resource.JFaceResources", "$wt.events.DisposeListener", "$.FocusAdapter", "$.KeyAdapter", "$wt.graphics.GC", "$wt.layout.GridData", "$wt.widgets.Text"], function () {
...
case 0:
this.textField.addKeyListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.StringFieldEditor$1") ? 0 : org.eclipse.jface.preference.StringFieldEditor.$StringFieldEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.StringFieldEditor$1, this, null)));
break;
case 1:
this.textField.addKeyListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.StringFieldEditor$2") ? 0 : org.eclipse.jface.preference.StringFieldEditor.$StringFieldEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.StringFieldEditor$2, this, null)));
this.textField.addFocusListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.StringFieldEditor$3") ? 0 : org.eclipse.jface.preference.StringFieldEditor.$StringFieldEditor$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.StringFieldEditor$3, this, null)));
break;
default:
;
}
this.textField.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.StringFieldEditor$4") ? 0 : org.eclipse.jface.preference.StringFieldEditor.$StringFieldEditor$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.StringFieldEditor$4, this, null)));
if (this.textLimit > 0) {
...
c$.$StringFieldEditor$1$ = function () {
Clazz.pu$h ();
...
c$.$StringFieldEditor$2$ = function () {
Clazz.pu$h ();
...
c$.$StringFieldEditor$3$ = function () {
Clazz.pu$h ();
...
c$.$StringFieldEditor$4$ = function () {
Clazz.pu$h ();

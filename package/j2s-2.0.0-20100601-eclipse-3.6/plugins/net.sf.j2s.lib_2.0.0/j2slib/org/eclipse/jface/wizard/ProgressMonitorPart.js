...
Clazz.load (["org.eclipse.core.runtime.IProgressMonitorWithBlocking", "$wt.widgets.Composite", "$.Listener"], "org.eclipse.jface.wizard.ProgressMonitorPart", ["java.lang.StringBuffer", "org.eclipse.jface.dialogs.ProgressIndicator", "org.eclipse.jface.resource.JFaceResources", "$wt.graphics.GC", "$wt.layout.GridData", "$.GridLayout", "$wt.widgets.Label"], function () {
...
this.fCancelListener = ((Clazz.isClassDefined ("org.eclipse.jface.wizard.ProgressMonitorPart$1") ? 0 : org.eclipse.jface.wizard.ProgressMonitorPart.$ProgressMonitorPart$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.wizard.ProgressMonitorPart$1, this, null));
});
...
c$.$ProgressMonitorPart$1$ = function () {
Clazz.pu$h ();

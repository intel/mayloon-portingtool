...
label.getAccessible ().addAccessibleListener (((Clazz.isClassDefined ("org.eclipse.jface.dialogs.IconAndMessageDialog$1") ? 0 : org.eclipse.jface.dialogs.IconAndMessageDialog.$IconAndMessageDialog$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.dialogs.IconAndMessageDialog$1, this, Clazz.cloneFinals ("image", image))));
...
display.syncExec (((Clazz.isClassDefined ("org.eclipse.jface.dialogs.IconAndMessageDialog$2") ? 0 : org.eclipse.jface.dialogs.IconAndMessageDialog.$IconAndMessageDialog$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.dialogs.IconAndMessageDialog$2, this, Clazz.cloneFinals ("image", image, "display", display, "imageID", imageID))));
return image[0];
}, $fz.isPrivate = true, $fz), "~N");
c$.$IconAndMessageDialog$1$ = function () {
Clazz.pu$h ();
...
c$.$IconAndMessageDialog$2$ = function () {
Clazz.pu$h ();

...
org.eclipse.jface.viewers.AbstractTreeViewer.$AbstractTreeViewer$UpdateItemSafeRunnable$ ();
}
...
if (data != null) return ;
}$wt.custom.BusyIndicator.showWhile (widget.getDisplay (), ((Clazz.isClassDefined ("org.eclipse.jface.viewers.AbstractTreeViewer$1") ? 0 : org.eclipse.jface.viewers.AbstractTreeViewer.$AbstractTreeViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.AbstractTreeViewer$1, this, Clazz.cloneFinals ("tis", tis, "widget", widget))));
}, "$wt.widgets.Widget");
...
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.AbstractTreeViewer$2") ? 0 : org.eclipse.jface.viewers.AbstractTreeViewer.$AbstractTreeViewer$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.AbstractTreeViewer$2, this, Clazz.cloneFinals ("l", l, "event", event))));
}
...
for (var i = 0; i < listeners.length; ++i) {
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.AbstractTreeViewer$3") ? 0 : org.eclipse.jface.viewers.AbstractTreeViewer.$AbstractTreeViewer$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.AbstractTreeViewer$3, this, Clazz.cloneFinals ("l", l, "event", event))));
}
}, "org.eclipse.jface.viewers.TreeExpansionEvent");
...
this.addTreeListener (control, ((Clazz.isClassDefined ("org.eclipse.jface.viewers.AbstractTreeViewer$4") ? 0 : org.eclipse.jface.viewers.AbstractTreeViewer.$AbstractTreeViewer$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.AbstractTreeViewer$4, this, null)));
}, "$wt.widgets.Control");
Clazz.overrideMethod (c$, "inputChanged", 
function (input, oldInput) {
this.preservingSelection (((Clazz.isClassDefined ("org.eclipse.jface.viewers.AbstractTreeViewer$5") ? 0 : org.eclipse.jface.viewers.AbstractTreeViewer.$AbstractTreeViewer$5$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.AbstractTreeViewer$5, this, null)));
}, "~O,~O");
...
this.preservingSelection (((Clazz.isClassDefined ("org.eclipse.jface.viewers.AbstractTreeViewer$6") ? 0 : org.eclipse.jface.viewers.AbstractTreeViewer.$AbstractTreeViewer$6$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.AbstractTreeViewer$6, this, Clazz.cloneFinals ("elements", elements))));
}, "~A");
Clazz.defineMethod (c$, "remove", 
function (element) {
this.remove ([element]);
...
c$.$AbstractTreeViewer$UpdateItemSafeRunnable$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
c$.$AbstractTreeViewer$1$ = function () {
Clazz.pu$h ();
...
c$.$AbstractTreeViewer$2$ = function () {
Clazz.pu$h ();
...
c$.$AbstractTreeViewer$3$ = function () {
Clazz.pu$h ();
...
c$.$AbstractTreeViewer$4$ = function () {
Clazz.pu$h ();
...
c$.$AbstractTreeViewer$5$ = function () {
Clazz.pu$h ();
...
c$.$AbstractTreeViewer$6$ = function () {
Clazz.pu$h ();

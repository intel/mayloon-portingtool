...
this.contextLock =  new JavaObject ();
});
...
var cl = java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleContextImpl$1") ? 0 : org.eclipse.osgi.framework.internal.core.BundleContextImpl.$BundleContextImpl$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleContextImpl$1, this, Clazz.cloneFinals ("serviceObject", serviceObject))));
for (var i = 0; i < clazzes.length; i++) {
try {
...
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleContextImpl$2") ? 0 : org.eclipse.osgi.framework.internal.core.BundleContextImpl.$BundleContextImpl$2$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleContextImpl$2, this, Clazz.cloneFinals ("bundleActivator", bundleActivator))));
} catch (t) {
...
function () {
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleContextImpl$3") ? 0 : org.eclipse.osgi.framework.internal.core.BundleContextImpl.$BundleContextImpl$3$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleContextImpl$3, this, null)));
} catch (t) {
if (Clazz.instanceOf (t, Throwable)) {
if (Clazz.instanceOf (t, java.security.PrivilegedActionException)) {
t = (t).getException ();
...
c$.$BundleContextImpl$1$ = function () {
Clazz.pu$h ();
...
c$.$BundleContextImpl$2$ = function () {
Clazz.pu$h ();
...
c$.$BundleContextImpl$3$ = function () {
Clazz.pu$h ();

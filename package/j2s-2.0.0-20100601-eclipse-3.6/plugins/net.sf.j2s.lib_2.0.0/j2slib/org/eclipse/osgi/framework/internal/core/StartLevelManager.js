...
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.StartLevelManager$1") ? 0 : org.eclipse.osgi.framework.internal.core.StartLevelManager.$StartLevelManager$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.StartLevelManager$1, this, Clazz.cloneFinals ("b", b))));
} catch (e) {
...
c$.$StartLevelManager$1$ = function () {
Clazz.pu$h ();
...
"activeSL", 0);
c$.lock = c$.prototype.lock =  new JavaObject ();
});

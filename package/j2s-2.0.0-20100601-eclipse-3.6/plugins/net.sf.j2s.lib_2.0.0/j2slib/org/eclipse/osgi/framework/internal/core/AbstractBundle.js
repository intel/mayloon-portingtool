...
this.statechangeLock =  new JavaObject ();
});
...
function (mask, state) {
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$1") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$1, this, Clazz.cloneFinals ("mask", mask, "state", state))));
} catch (pae) {
...
this.updateWorker (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$2") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$2$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$2, this, Clazz.cloneFinals ("callerContext", callerContext))));
} finally {
this.completeStateChange ();
}
});
...
try {
var callerContext = java.security.AccessController.getContext ();
this.updateWorker (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$3") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$3$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$3, this, Clazz.cloneFinals ("in", in, "callerContext", callerContext))));
} finally {
this.completeStateChange ();
}
}, "java.io.InputStream");
...
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$4") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$4$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$4, this, Clazz.cloneFinals ("newBundle", newBundle, "extension", extension))), callerContext);
} catch (e) {
...
this.beginStateChange ();
try {
this.uninstallWorker (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$5") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$5$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$5, this, null)));
} finally {
this.completeStateChange ();
}
});
...
this.checkValid ();
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$6") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$6$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$6, this, Clazz.cloneFinals ("path", path))));
}, "~S");
...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$7") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$7$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$7, this, Clazz.cloneFinals ("ffileName", ffileName))));
}, "~S");
...
return ((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.AbstractBundle$8") ? 0 : org.eclipse.osgi.framework.internal.core.AbstractBundle.$AbstractBundle$8$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.AbstractBundle$8, this, Clazz.cloneFinals ("pathArray", pathArray, "numFragments", numFragments, "fragments", fragments)));
}, "~S,~S,~B");

...
var refresh = this.framework.secureAction.createThread (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.PackageAdminImpl$1") ? 0 : org.eclipse.osgi.framework.internal.core.PackageAdminImpl.$PackageAdminImpl$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.PackageAdminImpl$1, this, Clazz.cloneFinals ("bundles", bundles))), "Refresh Packages");
refresh.start ();
}, "~A");
...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.PackageAdminImpl$2") ? 0 : org.eclipse.osgi.framework.internal.core.PackageAdminImpl.$PackageAdminImpl$2$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.PackageAdminImpl$2, this, Clazz.cloneFinals ("clazz", clazz))));
}, "Class");

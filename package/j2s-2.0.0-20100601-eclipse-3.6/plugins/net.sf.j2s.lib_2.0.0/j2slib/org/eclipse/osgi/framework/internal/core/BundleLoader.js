...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleLoader$2") ? 0 : org.eclipse.osgi.framework.internal.core.BundleLoader.$BundleLoader$2$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleLoader$2, this, Clazz.cloneFinals ("clazz", clazz))));
...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleLoader$3") ? 0 : org.eclipse.osgi.framework.internal.core.BundleLoader.$BundleLoader$3$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleLoader$3, this, Clazz.cloneFinals ("name", name))));
}, "~S");
...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleLoader$4") ? 0 : org.eclipse.osgi.framework.internal.core.BundleLoader.$BundleLoader$4$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleLoader$4, this, Clazz.cloneFinals ("pd", pd, "cp", cp))));
...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleLoader$5") ? 0 : org.eclipse.osgi.framework.internal.core.BundleLoader.$BundleLoader$5$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleLoader$5, this, Clazz.cloneFinals ("bcl", bcl))));
}, $fz.isPrivate = true, $fz), "org.eclipse.osgi.framework.adaptor.BundleClassLoader");
c$.$BundleLoader$2$ = function () {
Clazz.pu$h ();
...
"FLAG_CLOSED", 0x08);
c$.CLASS_CONTEXT = c$.prototype.CLASS_CONTEXT = java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.BundleLoader$1") ? 0 : org.eclipse.osgi.framework.internal.core.BundleLoader.$BundleLoader$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.BundleLoader$1, this, null)));

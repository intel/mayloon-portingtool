...
var service;
try {
service = java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.ServiceUse$1") ? 0 : org.eclipse.osgi.framework.internal.core.ServiceUse.$ServiceUse$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.ServiceUse$1, this, null)));
} catch (t) {
...
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.ServiceUse$2") ? 0 : org.eclipse.osgi.framework.internal.core.ServiceUse.$ServiceUse$2$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.ServiceUse$2, this, null)));
} catch (t) {
if (Clazz.instanceOf (t, Throwable)) {
...
if ((this.useCount > 0) && (this.factory != null)) {
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.ServiceUse$3") ? 0 : org.eclipse.osgi.framework.internal.core.ServiceUse.$ServiceUse$3$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.ServiceUse$3, this, null)));
} catch (t) {
if (Clazz.instanceOf (t, Throwable)) {
if (true && org.eclipse.osgi.framework.debug.Debug.DEBUG_SERVICES) {
org.eclipse.osgi.framework.debug.Debug.println (this.factory + ".ungetService() exception");

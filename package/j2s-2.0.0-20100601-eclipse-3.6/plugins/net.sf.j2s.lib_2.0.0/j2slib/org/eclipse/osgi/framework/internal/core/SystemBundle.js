...
this.framework.checkAdminPermission (this, "execute");
if (this.state == 32) {
var shutdown = this.framework.secureAction.createThread (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.SystemBundle$1") ? 0 : org.eclipse.osgi.framework.internal.core.SystemBundle.$SystemBundle$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.SystemBundle$1, this, null)), "System Bundle Shutdown");
shutdown.start ();
}});
...
if (this.state == 32) {
var restart = this.framework.secureAction.createThread (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.SystemBundle$2") ? 0 : org.eclipse.osgi.framework.internal.core.SystemBundle.$SystemBundle$2$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.SystemBundle$2, this, null)), "System Bundle Update");
restart.start ();
}});
Clazz.defineMethod (c$, "update", 
function ($in) {

...
return this.installWorker (location, ((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$1") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$1$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$1, this, Clazz.cloneFinals ("location", location, "callerContext", callerContext))));
}, "~S");
Clazz.defineMethod (c$, "installBundle", 
...
return this.installWorker (location, ((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$2") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$2$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$2, this, Clazz.cloneFinals ("in", in, "location", location, "callerContext", callerContext))));
...
try {
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$3") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$3$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$3, this, Clazz.cloneFinals ("bundle", bundle, "extension", extension))), callerContext);
} catch (e) {
if (Clazz.instanceOf (e, java.security.PrivilegedActionException)) {
throw e.getException ();
} else {
...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$4") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$4$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$4, this, Clazz.cloneFinals ("finalLocation", finalLocation))));
}}, "~S");
Clazz.defineMethod (c$, "getBundleBySymbolicName", 
...
return java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$5") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$5$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$5, this, Clazz.cloneFinals ("bundle", bundle, "filename", filename))));
...
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$6") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$6$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$6, this, Clazz.cloneFinals ("event", event))));
...
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$7") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$7$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$7, this, Clazz.cloneFinals ("event", event))));
...
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.Framework$8") ? 0 : org.eclipse.osgi.framework.internal.core.Framework.$Framework$8$ ()), Clazz.innerTypeInstance (org.eclipse.osgi.framework.internal.core.Framework$8, this, Clazz.cloneFinals ("event", event))));

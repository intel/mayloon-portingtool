/* http://j2s.sf.net/ */$_L(["$wt.widgets.Item"],"$wt.widgets.TrayItem",["java.util.Date","$wt.internal.RunnableCompatibility","$wt.internal.browser.OS","$wt.internal.dnd.HTMLEventWrapper","$wt.widgets.Event","$.TypedListener"],function(){
c$=$_C(function(){
this.parent=null;
this.id=0;

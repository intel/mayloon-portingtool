...
function (test) {
this.startTest (test);
var p = ((Clazz.isClassDefined ("junit.framework.TestResult$1") ? 0 : junit.framework.TestResult.$TestResult$1$ ()), Clazz.innerTypeInstance (junit.framework.TestResult$1, this, Clazz.cloneFinals ("test", test)));

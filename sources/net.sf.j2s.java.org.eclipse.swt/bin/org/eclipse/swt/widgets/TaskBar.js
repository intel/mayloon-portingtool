...
$WTC$$.registerCSS ("$wt.widgets.TaskBar"); c$ = $_C (function () {
this.barEl = null;
this.items = null;
...
$_K(c$,
function(shell,text,itemHandle,textHandle,iconHandle,itemClick,textSelection){
this.shell=shell;
this.text=text;
...
Clazz.removeEvent(this.itemHandle,"mouseover",bar.hBarMouesEnter);

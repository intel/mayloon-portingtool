...
public class JavaRuntimeJSProvider implements IExternalResourceProvider {
    ...
    */
    ...
    public String[][] getResources() {
        ...
        try {
            URL ajaxURL = Platform.getBundle("net.sf.j2s.ajax").getEntry("/" + File.separator);
            srcPath = Platform.asLocalURL(ajaxURL).getFile().replace("net.sf.j2s.ajax", "net.sf.j2s.lib");
        } catch (IOException e) {
            e.printStackTrace();
        } catch (Exception e) {
            e.printStackTrace();

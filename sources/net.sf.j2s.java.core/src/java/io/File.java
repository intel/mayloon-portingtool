...
public class File implements Serializable, Comparable<File> {
    ...
    private void init(String dirtyPath) {
        ...
        if (isAbsolute) {
            ...
            String userDir = new String("");//AccessController.doPrivileged(new PriviAction<String>("user.dir"));
    ...
    private static boolean canReadImpl(String path) {
    	return existsImpl(path) ? true : false;
    }
    ...
    private static boolean canWriteImpl(String path) {
    	 return existsImpl(path) ? true : false;
    }
    ...
    private static String readlink(String filePath) {
    	return filePath;
    }
    ...
    private static boolean setLastModifiedImpl(String path, long time) {
    	// TODO: return dummy true if exsits
    	return existsImpl(path) ? true : false;
    }
    ...
    private static boolean setReadableImpl(String path, boolean readable, boolean ownerOnly) {
    	return existsImpl(path) ? true : false;
    }
    ...
    private static boolean setWritableImpl(String path, boolean writable, boolean ownerOnly) {
    	// Return dummy true if exists
    	return existsImpl(path) ? true : false;
    }
    ...
    public static File createTempFile(String prefix, String suffix,
        ...
        if (tmpDirFile == null) {
            String tmpDir = new String("");//AccessController.doPrivileged(
    ...
    private static boolean renameToImpl(String oldPath, String newPath) {
    	String folder = null;
    	String name = newPath;
    ...
    private static long getTotalSpaceImpl(String path) {
    	/**
    	 * TODO: TBD
    	 */
    ...
    private static long getUsableSpaceImpl(String path) {
    	/**
    	 * TODO: TBD
    	 */
    	return Long.MAX_VALUE;
    ...
    private static long getFreeSpaceImpl(String path) {
    	/**
    	 * TODO: How to ??? (TBD)
    	 */
    	return Long.MAX_VALUE;

...
public class RandomAccessFile implements DataInput, DataOutput, Closeable {
    ...
    private JSFileSystem fileSystem = JSFileSystem.getJSFileSystem();
    ...
    public RandomAccessFile(File file, String mode) throws FileNotFoundException {
        ...
        if (mode.equals("r")) {
            isReadOnly = true;
            fd.readOnly = true;
            options = JSFileSystem.O_RDONLY;
        } else if (mode.equals("rw") || mode.equals("rws") || mode.equals("rwd")) {
            isReadOnly = false;
            options = JSFileSystem.O_RDWR;
            ...
            if (mode.equals("rws")) {
                ...
                options = JSFileSystem.O_RDWRSYNC;
            }
        } else {
        ...
        fd = fileSystem.open(file.getAbsolutePath(), options);
    ...
    public long getFilePointer() throws IOException {
        openCheck();
        return fileSystem.seek(fd.descriptor, 0L, JSFileSystem.SEEK_CUR);
    }
...
//        return Float.intBitsToFloat(readInt());
    ...
    public void seek(long offset) throws IOException {
        ...
        openCheck();
        fileSystem.seek(fd.descriptor, offset, JSFileSystem.SEEK_SET);
    }

 ...
 * </ul>
 */
public final class Class<T> implements Serializable,  Type {
...
/*    private String getSignatureAttribute() {
    ...
    public static Class<?> forName(String className) throws ClassNotFoundException {
        return null;//forName(className, true, VMStack.getCallingClassLoader());
    }
...
//                sb.append(p.getSimpleName());
   ...
   /* public Field[] getDeclaredFields() throws SecurityException {
    ...
    public Method getDeclaredMethod(String name, Class<?>... parameterTypes)
         ...
         * setAccessible() won't alter the private instance.
         */
        return null;//REFLECT.clone(method);
    }
    ...
    public Method[] getDeclaredMethods() throws SecurityException {
        ...
        // Return a copy of the private (to the package) array.
        Method[] methods = getClassCache().getDeclaredMethods();*/
        return null;//ClassCache.deepCopy(methods);
    }
...
//    native public Method getEnclosingMethod();
   ...
   /* public Field getField(String name) throws NoSuchFieldException, SecurityException {
        ...
        return null;// REFLECT.clone(field);
    }*/
    ...
    /*public Field[] getFields() throws SecurityException {
        ...
        // Return a copy of the private (to the package) array.
//        Field[] fields = getClassCache().getAllPublicFields();
        return null;//ClassCache.deepCopy(fields);
    }*/

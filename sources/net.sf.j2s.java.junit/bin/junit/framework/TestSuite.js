...
Clazz.load (["junit.framework.Test", "java.lang.reflect.Constructor"], "junit.framework.TestSuite", ["java.lang.Void", "java.lang.reflect.Modifier", "java.util.Vector", "junit.framework.TestCase"], function () {
...
($fz = function (message) {
return ((Clazz.isClassDefined ("junit.framework.TestSuite$1") ? 0 : junit.framework.TestSuite.$TestSuite$1$ ()), Clazz.innerTypeInstance (junit.framework.TestSuite$1, this, Clazz.cloneFinals ("message", message), "warning"));
}, $fz.isPrivate = true, $fz), "~S");
c$.$TestSuite$1$ = function () {
Clazz.pu$h ();

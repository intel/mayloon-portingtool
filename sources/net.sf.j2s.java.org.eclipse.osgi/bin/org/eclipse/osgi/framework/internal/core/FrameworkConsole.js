...
org.eclipse.osgi.framework.internal.core.FrameworkConsole.$FrameworkConsole$ConsoleSocketGetter$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.osgi.framework.internal.core.FrameworkConsole.CommandProviderTracker")) {
org.eclipse.osgi.framework.internal.core.FrameworkConsole.$FrameworkConsole$CommandProviderTracker$ ();
}
...
c$.$FrameworkConsole$ConsoleSocketGetter$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function (server) {
this.server = server;
var t =  new Thread (this, "ConsoleSocketGetter");
t.start ();
...
var o = this.b$["org.eclipse.osgi.framework.internal.core.FrameworkConsole"].createPrintWriter (this.socket.getOutputStream ());
o.println (org.eclipse.osgi.framework.internal.core.ConsoleMsg.CONSOLE_TELNET_CONNECTION_REFUSED);
o.println (org.eclipse.osgi.framework.internal.core.ConsoleMsg.CONSOLE_TELNET_CURRENTLY_USED);
o.println (org.eclipse.osgi.framework.internal.core.ConsoleMsg.CONSOLE_TELNET_ONE_CLIENT_ONLY);
o.close ();
this.socket.close ();
} else {
{
...
c$.$FrameworkConsole$CommandProviderTracker$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
this.con = null;
...
Clazz.makeConstructor (c$, 
function (context, clazz, con) {
Clazz.superConstructor (this, org.eclipse.osgi.framework.internal.core.FrameworkConsole.CommandProviderTracker, [context, clazz, null]);
this.con = con;
...
function (reference) {
var cp = Clazz.superCall (this, org.eclipse.osgi.framework.internal.core.FrameworkConsole.CommandProviderTracker, "addingService", [reference]);
return cp;
}, "org.osgi.framework.ServiceReference");
Clazz.overrideMethod (c$, "getServices", 
function () {
var serviceRefs = Clazz.superCall (this, org.eclipse.osgi.framework.internal.core.FrameworkConsole.CommandProviderTracker, "getServiceReferences", []);
org.eclipse.osgi.framework.internal.core.Util.dsort (serviceRefs, 0, serviceRefs.length);
var serviceObjects =  new Array (serviceRefs.length);
for (var i = 0; i < serviceRefs.length; i++) {
serviceObjects[i] = this.b$["org.eclipse.osgi.framework.internal.core.FrameworkConsole"].context.getService (serviceRefs[i]);
}

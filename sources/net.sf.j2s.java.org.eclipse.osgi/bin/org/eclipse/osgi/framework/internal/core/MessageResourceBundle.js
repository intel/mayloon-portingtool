...
function (fieldMap, bundleName, isAccessible) {
...
function (key, value) {
var fieldObject = this.fields.put (key, org.eclipse.osgi.framework.internal.core.MessageResourceBundle.ASSIGNED);
if (fieldObject === org.eclipse.osgi.framework.internal.core.MessageResourceBundle.ASSIGNED) return null;
if (fieldObject == null) {
var msg = "NLS unused message: " + key + " in: " + this.bundleName;
if (org.eclipse.osgi.framework.debug.Debug.DEBUG_MESSAGE_BUNDLES) System.out.println (msg);
org.eclipse.osgi.framework.internal.core.MessageResourceBundle.log (org.eclipse.osgi.framework.internal.core.MessageResourceBundle.SEVERITY_WARNING, msg, null);
return null;
}var field = fieldObject;
if ((field.getModifiers () & 25) != 9) return null;
try {
...
Clazz.defineStatics (c$,
"adaptor", null);
c$.ASSIGNED = c$.prototype.ASSIGNED =  new JavaObject ();
Clazz.defineStatics (c$,

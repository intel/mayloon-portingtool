...
org.eclipse.osgi.framework.internal.core.BundleLoaderProxy.$BundleLoaderProxy$ReexportPackageSource$ ();
}
...
c$.$BundleLoaderProxy$ReexportPackageSource$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function () {
var source = this.b$["org.eclipse.osgi.framework.internal.core.BundleLoaderProxy"].getBundleLoader ().getPackageSource (this.id);
...
function (name) {
try {
return this.b$["org.eclipse.osgi.framework.internal.core.BundleLoaderProxy"].getBundleLoader ().findClass (name, false);
} catch (e) {
...
function (name) {
return this.b$["org.eclipse.osgi.framework.internal.core.BundleLoaderProxy"].getBundleLoader ().findResource (name, false);
}, "~S");
Clazz.overrideMethod (c$, "getResources", 
function (name) {
return this.b$["org.eclipse.osgi.framework.internal.core.BundleLoaderProxy"].getBundleLoader ().findResources (name);
}, "~S");
c$ = Clazz.p0p ();
};
});

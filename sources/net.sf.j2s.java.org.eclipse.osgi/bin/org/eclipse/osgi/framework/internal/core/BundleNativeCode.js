...
var data = this.$elementData[i];
if (Clazz.instanceOf (data, String)) {
...
Clazz.superCall (this, org.eclipse.osgi.framework.internal.core.BundleNativeCode.Attribute, "addElement", [obj]);
}}, "~O");
c$ = Clazz.p0p ();

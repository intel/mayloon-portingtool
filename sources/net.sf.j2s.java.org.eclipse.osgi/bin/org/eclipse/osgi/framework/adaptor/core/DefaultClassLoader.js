...
org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.$DefaultClassLoader$FragmentClasspath$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.ClasspathEntry")) {
org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.$DefaultClassLoader$ClasspathEntry$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.ClasspathDomain")) {
org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.$DefaultClassLoader$ClasspathDomain$ ();
}
...
c$.$DefaultClassLoader$FragmentClasspath$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
Clazz.makeConstructor (c$, 
function (classpathEntries, bundledata, domain) {
...
c$.$DefaultClassLoader$ClasspathEntry$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
...
this.domain = this.createProtectionDomain (domain);
}, "org.eclipse.osgi.framework.adaptor.core.BundleFile,java.security.ProtectionDomain");
...
try {
var permissions;
if (baseDomain != null) permissions = baseDomain.getPermissions ();
 else permissions = org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.ALLPERMISSIONS;
return Clazz.innerTypeInstance (org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.ClasspathDomain, this, null, this.bundlefile.getBaseFile ().toURL (), permissions);
} catch (e) {
...
c$.$DefaultClassLoader$ClasspathDomain$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
...
Clazz.makeConstructor (c$, 
function (codeLocation, permissions) {
Clazz.superConstructor (this, org.eclipse.osgi.framework.adaptor.core.DefaultClassLoader.ClasspathDomain, [ new java.security.CodeSource (codeLocation, Clazz.castNullAs ("Array")), permissions]);

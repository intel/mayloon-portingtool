...
org.eclipse.core.runtime.internal.adaptor.PluginParser.$PluginParser$PluginInfo$ ();
}
this.stateStack = null;
this.objectStack = null;
this.locator = null;
if (!Clazz.isClassDefined ("org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite")) {
org.eclipse.core.runtime.internal.adaptor.PluginParser.$PluginParser$Prerequisite$ ();
}
...
c$.$PluginParser$PluginInfo$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
for (var i = 0; i < this.requires.size (); i++) {
var analyzed = this.requires.get (i);
if ("org.eclipse.ui".equals (analyzed.getName ())) {
this.requires.add (i + 1, Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.ui.workbench.texteditor", null, true, analyzed.isExported (), null));
this.requires.add (i + 1, Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.jface.text", null, true, analyzed.isExported (), null));
this.requires.add (i + 1, Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.ui.editors", null, true, analyzed.isExported (), null));
this.requires.add (i + 1, Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.ui.views", null, true, analyzed.isExported (), null));
this.requires.add (i + 1, Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.ui.ide", null, true, analyzed.isExported (), null));
} else if ("org.eclipse.help".equals (analyzed.getName ())) {
this.requires.add (i + 1, Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.help.base", null, true, analyzed.isExported (), null));
} else if ("org.eclipse.core.runtime".equals (analyzed.getName ()) && !this.compatibilityFound) {
this.requires.add (i + 1, Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.core.runtime.compatibility", null, false, analyzed.isExported (), null));
}}
...
this.requires.add (Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.core.runtime.compatibility", null, false, false, null));
}var runtimePrereq = Clazz.innerTypeInstance (org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite, this, null, "org.eclipse.core.runtime", null, false, false, null);
...
c$.$PluginParser$Prerequisite$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
this.name = null;
...
Clazz.makeConstructor (c$, 
function (preqName, prereqVersion, isOtional, isExported, prereqMatch) {
this.name = preqName;
...
function (prereq) {
if (!(Clazz.instanceOf (prereq, org.eclipse.core.runtime.internal.adaptor.PluginParser.Prerequisite))) return false;
return this.name.equals ((prereq).name);
}, "~O");
c$ = Clazz.p0p ();
};
Clazz.defineStatics (c$,

...
org.eclipse.core.runtime.adaptor.EclipseAdaptor.$EclipseAdaptor$SaxParsingService$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.core.runtime.adaptor.EclipseAdaptor.DomParsingService")) {
org.eclipse.core.runtime.adaptor.EclipseAdaptor.$EclipseAdaptor$DomParsingService$ ();
}
...
c$.$EclipseAdaptor$SaxParsingService$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function (bundle, registration, service) {
}, "org.osgi.framework.Bundle,org.osgi.framework.ServiceRegistration,~O");
c$ = Clazz.p0p ();
};
c$.$EclipseAdaptor$DomParsingService$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);

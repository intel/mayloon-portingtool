...
java.security.AccessController.doPrivileged (((Clazz.isClassDefined ("org.osgi.framework.AdminPermission$1") ? 0 : org.osgi.framework.AdminPermission.$AdminPermission$1$ ()), Clazz.innerTypeInstance (org.osgi.framework.AdminPermission$1, this, null)));
...
Clazz.overrideMethod (c$, "equals", 
function (o) {
if (!(Clazz.instanceOf (o, org.osgi.framework.AdminPermission.SignerWrapper))) return false;
var other = o;
var matchBundle = (this.bundle != null ? this.bundle : other.bundle);
var matchPattern = this.bundle != null ? other.pattern : this.pattern;

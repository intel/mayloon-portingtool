...
org.osgi.util.tracker.ServiceTracker.$ServiceTracker$Tracked$ ();
}
if (!Clazz.isClassDefined ("org.osgi.util.tracker.ServiceTracker.AllTracked")) {
org.osgi.util.tracker.ServiceTracker.$ServiceTracker$AllTracked$ ();
}
...
c$.$ServiceTracker$Tracked$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
if (this.b$["org.osgi.util.tracker.ServiceTracker"].filter.match (reference)) {
this.track (reference);
} else {
...
}this.b$["org.osgi.util.tracker.ServiceTracker"].customizer.modifiedService (reference, object);
return ;
}{
...
}var becameUntracked = false;
try {
object = this.b$["org.osgi.util.tracker.ServiceTracker"].customizer.addingService (reference);
} finally {
{
...
}this.b$["org.osgi.util.tracker.ServiceTracker"].customizer.removedService (reference, object);
}}, "org.osgi.framework.ServiceReference");
...
c$.$ServiceTracker$AllTracked$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);

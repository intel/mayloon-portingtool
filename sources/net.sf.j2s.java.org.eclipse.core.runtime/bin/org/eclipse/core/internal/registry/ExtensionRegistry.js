...
org.eclipse.core.internal.registry.ExtensionRegistry.$ExtensionRegistry$ListenerInfo$ ();
}
this.access = null;
this.deltas = null;
...
if (org.eclipse.core.internal.registry.ExtensionRegistry.DEBUG) this.addRegistryChangeListener (((Clazz.isClassDefined ("org.eclipse.core.internal.registry.ExtensionRegistry$1") ? 0 : org.eclipse.core.internal.registry.ExtensionRegistry.$ExtensionRegistry$1$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.registry.ExtensionRegistry$1, this, null)));
...
c$.$ExtensionRegistry$ListenerInfo$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function (another) {
return Clazz.instanceOf (another, org.eclipse.core.internal.registry.ExtensionRegistry.ListenerInfo) && (another).listener === this.listener;
}, "~O");
c$ = Clazz.p0p ();
};
c$.$ExtensionRegistry$1$ = function () {
Clazz.pu$h ();
...
function (monitor) {
var result =  new org.eclipse.core.runtime.MultiStatus ("org.eclipse.core.runtime", 0, org.eclipse.core.internal.runtime.Messages.plugin_eventListenerError, null);
for (var i = 0; i < this.listenerInfos.length; i++) {
var listenerInfo = this.listenerInfos[i];
if (listenerInfo.filter != null && !this.deltas.containsKey (listenerInfo.filter)) continue ;try {
listenerInfo.listener.registryChanged ( new org.eclipse.core.internal.registry.RegistryChangeEvent (this.deltas, listenerInfo.filter));
} catch (re) {
if (Clazz.instanceOf (re, RuntimeException)) {
var message = re.getMessage () == null ? "" : re.getMessage ();
result.add ( new org.eclipse.core.runtime.Status (4, "org.eclipse.core.runtime", 0, message, re));
} else {
throw re;
}
}
}
for (var iter = this.deltas.values ().iterator (); iter.hasNext (); ) {
(iter.next ()).getObjectManager ().close ();
}
return result;
}, "org.eclipse.core.runtime.IProgressMonitor");
c$.$ExtensionRegistry$ExtensionEventDispatcherJob$1$ = function () {
Clazz.pu$h ();
...
c$.EXTENSION_EVENT_RULE = c$.prototype.EXTENSION_EVENT_RULE = ((Clazz.isClassDefined ("org.eclipse.core.internal.registry.ExtensionRegistry$ExtensionEventDispatcherJob$1") ? 0 : org.eclipse.core.internal.registry.ExtensionRegistry.ExtensionEventDispatcherJob.$ExtensionRegistry$ExtensionEventDispatcherJob$1$ ()), Clazz.innerTypeInstance (org.eclipse.core.internal.registry.ExtensionRegistry$ExtensionEventDispatcherJob$1, this, null));
c$ = Clazz.p0p ();

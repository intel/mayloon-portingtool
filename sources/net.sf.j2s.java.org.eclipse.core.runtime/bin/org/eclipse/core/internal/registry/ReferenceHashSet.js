...
org.eclipse.core.internal.registry.ReferenceHashSet.$ReferenceHashSet$HashableWeakReference$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.core.internal.registry.ReferenceHashSet.HashableSoftReference")) {
org.eclipse.core.internal.registry.ReferenceHashSet.$ReferenceHashSet$HashableSoftReference$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.core.internal.registry.ReferenceHashSet.StrongReference")) {
org.eclipse.core.internal.registry.ReferenceHashSet.$ReferenceHashSet$StrongReference$ ();
}
this.values = null;
this.elementSize = 0;
this.threshold = 0;
...
c$.$ReferenceHashSet$HashableWeakReference$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
Clazz.superConstructor (this, org.eclipse.core.internal.registry.ReferenceHashSet.HashableWeakReference, [referent, queue]);
this.$hashCode = referent.hashCode ();
}, "~O,java.lang.ref.ReferenceQueue");
Clazz.defineMethod (c$, "equals", 
function (obj) {
if (!(Clazz.instanceOf (obj, org.eclipse.core.internal.registry.ReferenceHashSet.HashableWeakReference))) return false;
...
function () {
var referent = this.get ();
if (referent == null) return "[hashCode=" + this.$hashCode + "] <referent was garbage collected>";
return "[hashCode=" + this.$hashCode + "] " + referent.toString ();
});
c$ = Clazz.p0p ();
};
c$.$ReferenceHashSet$HashableSoftReference$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
this.$hashCode = 0;
...
Clazz.makeConstructor (c$, 
function (referent, queue) {
Clazz.superConstructor (this, org.eclipse.core.internal.registry.ReferenceHashSet.HashableSoftReference, [referent, queue]);
this.$hashCode = referent.hashCode ();
}, "~O,java.lang.ref.ReferenceQueue");
Clazz.defineMethod (c$, "equals", 
function (obj) {
...
c$.$ReferenceHashSet$StrongReference$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
this.referent = null;

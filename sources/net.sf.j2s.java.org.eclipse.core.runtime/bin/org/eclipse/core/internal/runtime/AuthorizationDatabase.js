...
Clazz.load (["java.util.Hashtable"], "org.eclipse.core.internal.runtime.AuthorizationDatabase", ["java.io.File", "$.FileInputStream", "$.FileOutputStream", "$.ObjectInputStream", "$.ObjectOutputStream", "org.eclipse.core.internal.runtime.CipherInputStream", "$.CipherOutputStream", "$.InternalPlatform", "$.Messages", "$.URLTool", "org.eclipse.core.runtime.CoreException", "$.Status", "org.eclipse.osgi.util.NLS"], function () {

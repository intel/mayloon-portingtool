...
org.eclipse.core.runtime.dynamichelpers.ExtensionTracker.$ExtensionTracker$HandlerWrapper$ ();
}
...
function (xpt) {
return ((Clazz.isClassDefined ("org.eclipse.core.runtime.dynamichelpers.ExtensionTracker$1") ? 0 : org.eclipse.core.runtime.dynamichelpers.ExtensionTracker.$ExtensionTracker$1$ ()), Clazz.innerTypeInstance (org.eclipse.core.runtime.dynamichelpers.ExtensionTracker$1, this, Clazz.cloneFinals ("xpt", xpt)));
}, "org.eclipse.core.runtime.IExtensionPoint");
c$.createExtensionPointFilter = Clazz.defineMethod (c$, "createExtensionPointFilter", 
function (xpts) {
return ((Clazz.isClassDefined ("org.eclipse.core.runtime.dynamichelpers.ExtensionTracker$2") ? 0 : org.eclipse.core.runtime.dynamichelpers.ExtensionTracker.$ExtensionTracker$2$ ()), Clazz.innerTypeInstance (org.eclipse.core.runtime.dynamichelpers.ExtensionTracker$2, this, Clazz.cloneFinals ("xpts", xpts)));
}, "~A");
c$.createNamespaceFilter = Clazz.defineMethod (c$, "createNamespaceFilter", 
function (id) {
return ((Clazz.isClassDefined ("org.eclipse.core.runtime.dynamichelpers.ExtensionTracker$3") ? 0 : org.eclipse.core.runtime.dynamichelpers.ExtensionTracker.$ExtensionTracker$3$ ()), Clazz.innerTypeInstance (org.eclipse.core.runtime.dynamichelpers.ExtensionTracker$3, this, Clazz.cloneFinals ("id", id)));
}, "~S");
c$.$ExtensionTracker$HandlerWrapper$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function (target) {
return this.handler.equals ((target).handler);
}, "~O");

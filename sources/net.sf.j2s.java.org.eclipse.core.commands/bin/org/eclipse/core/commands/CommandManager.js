...
org.eclipse.core.commands.CommandManager.$CommandManager$ExecutionListener$ ();
}
...
c$.$CommandManager$ExecutionListener$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function (commandId, exception) {
if (this.b$["org.eclipse.core.commands.CommandManager"].executionListeners != null) {
var executionListenersSize = this.b$["org.eclipse.core.commands.CommandManager"].executionListeners.size ();
if (executionListenersSize > 0) {
var listeners = this.b$["org.eclipse.core.commands.CommandManager"].executionListeners.toArray ( new Array (executionListenersSize));
...
function (commandId, returnValue) {
if (this.b$["org.eclipse.core.commands.CommandManager"].executionListeners != null) {
var executionListenersSize = this.b$["org.eclipse.core.commands.CommandManager"].executionListeners.size ();
if (executionListenersSize > 0) {
var listeners = this.b$["org.eclipse.core.commands.CommandManager"].executionListeners.toArray ( new Array (executionListenersSize));

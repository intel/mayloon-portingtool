...
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$1") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$1, this, Clazz.cloneFinals ("node", node))));
}}
...
newShell.addShellListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$2") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$2, this, null)));
}, "$wt.widgets.Shell");
...
$wt.custom.BusyIndicator.showWhile (this.getShell ().getDisplay (), ((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$3") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$3, this, Clazz.cloneFinals ("control", control, "parent", parent))));
return control[0];
}, "$wt.widgets.Composite");
...
sash.addListener (13, ((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$4") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$4, this, Clazz.cloneFinals ("sash", sash, "rightControl", rightControl, "composite", composite))));
return sash;
...
this.titleArea.addControlListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$5") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$5$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$5, this, null)));
var fontListener = ((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$6") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$6$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$6, this, null));
this.titleArea.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$7") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$7$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$7, this, Clazz.cloneFinals ("fontListener", fontListener))));
...
function (viewer) {
viewer.addPostSelectionChangedListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$8") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$8$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$8, this, Clazz.cloneFinals ("viewer", viewer))));
(viewer.getControl ()).addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$9") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$9$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$9, this, Clazz.cloneFinals ("viewer", viewer))));
viewer.getControl ().addHelpListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$10") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$10$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$10, this, null)));
...
function () {
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$11") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$11$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$11, this, null)));
});
...
var failed = [false];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$12") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$12$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$12, this, Clazz.cloneFinals ("failed", failed))));
if (failed[0]) return false;
;
}var size =  new Array (1);
var failed =  new $wt.graphics.Point (-1, -1);
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$13") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$13$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$13, this, Clazz.cloneFinals ("size", size, "failed", failed))));
...
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.preference.PreferenceDialog$14") ? 0 : org.eclipse.jface.preference.PreferenceDialog.$PreferenceDialog$14$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.PreferenceDialog$14, this, Clazz.cloneFinals ("l", l, "event", event))));
}
}, "org.eclipse.jface.dialogs.PageChangedEvent");
c$.$PreferenceDialog$PageLayout$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function (composite, wHint, hHint, force) {
if (wHint != -1 && hHint != -1) return  new $wt.graphics.Point (wHint, hHint);
var x = this.b$["org.eclipse.jface.preference.PreferenceDialog"].minimumPageSize.x;
var y = this.b$["org.eclipse.jface.preference.PreferenceDialog"].minimumPageSize.y;
var children = composite.getChildren ();
for (var i = 0; i < children.length; i++) {
var size = children[i].computeSize (-1, -1, force);
x = Math.max (x, size.x);
y = Math.max (y, size.y);
}
if (this.b$["org.eclipse.jface.preference.PreferenceDialog"].currentPage != null) {
var size = this.b$["org.eclipse.jface.preference.PreferenceDialog"].currentPage.computeSize ();
x = Math.max (x, size.x);
y = Math.max (y, size.y);
}if (wHint != -1) x = wHint;
if (hHint != -1) y = hHint;
...
c$.$PreferenceDialog$10$ = function () {
Clazz.pu$h ();
...
c$.$PreferenceDialog$11$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
...
c$.$PreferenceDialog$12$ = function () {
Clazz.pu$h ();
...
c$.$PreferenceDialog$13$ = function () {
Clazz.pu$h ();
...
c$.$PreferenceDialog$14$ = function () {
Clazz.pu$h ();

...
Clazz.load (["org.eclipse.jface.preference.FieldEditor"], "org.eclipse.jface.preference.RadioGroupFieldEditor", ["$wt.events.DisposeListener", "$.SelectionAdapter", "$wt.layout.GridData", "$.GridLayout", "$wt.widgets.Button", "$.Composite", "$.Group"], function () {
...
radio.setFont (font);
radio.addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.RadioGroupFieldEditor$1") ? 0 : org.eclipse.jface.preference.RadioGroupFieldEditor.$RadioGroupFieldEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.RadioGroupFieldEditor$1, this, null)));
}
this.radioBox.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.RadioGroupFieldEditor$2") ? 0 : org.eclipse.jface.preference.RadioGroupFieldEditor.$RadioGroupFieldEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.RadioGroupFieldEditor$2, this, null)));
} else {
...
c$.$RadioGroupFieldEditor$1$ = function () {
Clazz.pu$h ();
...
c$.$RadioGroupFieldEditor$2$ = function () {
Clazz.pu$h ();

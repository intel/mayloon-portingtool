...
Clazz.load (null, "org.eclipse.jface.preference.FieldEditor", ["java.lang.Boolean", "org.eclipse.jface.dialogs.Dialog", "org.eclipse.jface.util.PropertyChangeEvent", "$wt.events.DisposeListener", "$wt.graphics.GC", "$wt.layout.GridData", "$.GridLayout", "$wt.widgets.Label"], function () {
...
this.label.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.FieldEditor$1") ? 0 : org.eclipse.jface.preference.FieldEditor.$FieldEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.FieldEditor$1, this, null)));
} else {

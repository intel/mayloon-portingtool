...
Clazz.load (["org.eclipse.jface.preference.StringFieldEditor"], "org.eclipse.jface.preference.StringButtonFieldEditor", ["org.eclipse.jface.resource.JFaceResources", "$wt.events.DisposeListener", "$.SelectionAdapter", "$wt.layout.GridData", "$wt.widgets.Button"], function () {
...
this.changeButton.addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.StringButtonFieldEditor$1") ? 0 : org.eclipse.jface.preference.StringButtonFieldEditor.$StringButtonFieldEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.StringButtonFieldEditor$1, this, null)));
this.changeButton.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.StringButtonFieldEditor$2") ? 0 : org.eclipse.jface.preference.StringButtonFieldEditor.$StringButtonFieldEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.StringButtonFieldEditor$2, this, null)));
} else {
...
c$.$StringButtonFieldEditor$1$ = function () {
Clazz.pu$h ();
...
c$.$StringButtonFieldEditor$2$ = function () {
Clazz.pu$h ();

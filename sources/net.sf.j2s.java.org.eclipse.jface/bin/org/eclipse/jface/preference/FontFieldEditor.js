...
Clazz.load (["org.eclipse.jface.preference.FieldEditor"], "org.eclipse.jface.preference.FontFieldEditor", ["org.eclipse.jface.preference.PreferenceConverter", "org.eclipse.jface.resource.JFaceResources", "$.StringConverter", "$wt.events.DisposeListener", "$.SelectionAdapter", "$wt.graphics.Font", "$wt.layout.GridData", "$wt.widgets.Button", "$.FontDialog", "$.Label", "$.Text"], function () {
...
this.changeFontButton.addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.FontFieldEditor$1") ? 0 : org.eclipse.jface.preference.FontFieldEditor.$FontFieldEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.FontFieldEditor$1, this, null)));
this.changeFontButton.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.FontFieldEditor$2") ? 0 : org.eclipse.jface.preference.FontFieldEditor.$FontFieldEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.FontFieldEditor$2, this, null)));
...
this.valueControl.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.FontFieldEditor$3") ? 0 : org.eclipse.jface.preference.FontFieldEditor.$FontFieldEditor$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.FontFieldEditor$3, this, null)));
} else {
...
function (s, parent) {
this.string = s;
this.text =  new $wt.widgets.Text (parent, 2056);
this.text.addDisposeListener (((Clazz.isClassDefined ("org.eclipse.jface.preference.FontFieldEditor$DefaultPreviewer$1") ? 0 : org.eclipse.jface.preference.FontFieldEditor.DefaultPreviewer.$FontFieldEditor$DefaultPreviewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.preference.FontFieldEditor$DefaultPreviewer$1, this, null)));
...
this.font =  new $wt.graphics.Font (this.text.getDisplay (), fontData);
...
c$.$FontFieldEditor$DefaultPreviewer$1$ = function () {
Clazz.pu$h ();

...
var boldData = this.getModifiedFontData (1);
this.boldFont =  new $wt.graphics.Font ($wt.widgets.Display.getCurrent (), boldData);
return this.boldFont;
});
Clazz.defineMethod (c$, "getModifiedFontData", 
($fz = function (style) {
var styleData =  new Array (this.baseData.length);
for (var i = 0; i < styleData.length; i++) {
var base = this.baseData[i];
styleData[i] =  new $wt.graphics.FontData (base.getName (), base.getHeight (), base.getStyle () | style);
}
return styleData;
...
var italicData = this.getModifiedFontData (2);
this.italicFont =  new $wt.graphics.Font ($wt.widgets.Display.getCurrent (), italicData);
return this.italicFont;
});
Clazz.defineMethod (c$, "addAllocatedFontsToStale", 
function (defaultFont) {
if (defaultFont !== this.baseFont && this.baseFont != null) this.b$["org.eclipse.jface.resource.FontRegistry"].staleFonts.add (this.baseFont);
if (defaultFont !== this.boldFont && this.boldFont != null) this.b$["org.eclipse.jface.resource.FontRegistry"].staleFonts.add (this.boldFont);
if (defaultFont !== this.italicFont && this.italicFont != null) this.b$["org.eclipse.jface.resource.FontRegistry"].staleFonts.add (this.italicFont);
}, "$wt.graphics.Font");
c$ = Clazz.p0p ();
};

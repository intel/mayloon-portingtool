...
Clazz.load (["org.eclipse.jface.dialogs.IPageChangeProvider", "$.TitleAreaDialog", "org.eclipse.jface.wizard.IWizardContainer2", "$wt.widgets.Layout", "java.util.ArrayList", "org.eclipse.jface.util.ListenerList"], "org.eclipse.jface.wizard.WizardDialog", ["java.lang.Boolean", "java.util.HashMap", "org.eclipse.jface.dialogs.ControlEnableState", "$.IDialogConstants", "$.MessageDialog", "$.PageChangedEvent", "org.eclipse.jface.operation.ModalContext", "org.eclipse.jface.resource.JFaceResources", "org.eclipse.jface.util.SafeRunnable", "org.eclipse.jface.wizard.ProgressMonitorPart", "$wt.custom.BusyIndicator", "$wt.events.HelpListener", "$.SelectionAdapter", "$wt.graphics.Cursor", "$.Point", "$wt.layout.GridData", "$.GridLayout", "$wt.widgets.Button", "$.Composite", "$.Label"], function () {
...
org.eclipse.jface.wizard.WizardDialog.$WizardDialog$PageContainerFillLayout$ ();
}
...
this.cancelListener = ((Clazz.isClassDefined ("org.eclipse.jface.wizard.WizardDialog$1") ? 0 : org.eclipse.jface.wizard.WizardDialog.$WizardDialog$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.wizard.WizardDialog$1, this, null));
...
newShell.addHelpListener (((Clazz.isClassDefined ("org.eclipse.jface.wizard.WizardDialog$2") ? 0 : org.eclipse.jface.wizard.WizardDialog.$WizardDialog$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.wizard.WizardDialog$2, this, null)));
}, "$wt.widgets.Shell");
...
return ((Clazz.isClassDefined ("org.eclipse.jface.wizard.WizardDialog$3") ? 0 : org.eclipse.jface.wizard.WizardDialog.$WizardDialog$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.wizard.WizardDialog$3, this, null, composite, pmlayout, -1));
...
var finalPage = page;
$wt.custom.BusyIndicator.showWhile (this.getContents ().getDisplay (), ((Clazz.isClassDefined ("org.eclipse.jface.wizard.WizardDialog$4") ? 0 : org.eclipse.jface.wizard.WizardDialog.$WizardDialog$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.wizard.WizardDialog$4, this, Clazz.cloneFinals ("finalPage", finalPage))));
...
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.wizard.WizardDialog$5") ? 0 : org.eclipse.jface.wizard.WizardDialog.$WizardDialog$5$ ()), Clazz.innerTypeInstance (org.eclipse.jface.wizard.WizardDialog$5, this, Clazz.cloneFinals ("l", l, "event", event))));
}
}, "org.eclipse.jface.dialogs.PageChangedEvent");
c$.$WizardDialog$PageContainerFillLayout$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
result =  new $wt.graphics.Point (0, 0);
for (var i = 0; i < children.length; i++) {
var cp = children[i].computeSize (wHint, hHint, force);
...
var rect = this.getClientArea (composite);
var children = composite.getChildren ();
for (var i = 0; i < children.length; i++) {

...
Clazz.load (["org.eclipse.jface.viewers.StructuredViewer"], "org.eclipse.jface.viewers.TableViewer", ["java.util.ArrayList", "org.eclipse.jface.viewers.DoubleClickEvent", "$.OpenEvent", "$.TableEditorImpl", "$.ViewerLabel", "$wt.custom.TableEditor", "$wt.events.MouseAdapter", "$wt.widgets.Listener", "$.Table", "$.TableItem"], function () {
c$ = Clazz.decorateAsClass (function () {
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.TableViewer.VirtualManager")) {
org.eclipse.jface.viewers.TableViewer.$TableViewer$VirtualManager$ ();
}
this.virtualManager = null;
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.TableViewer.TableColorAndFontNoOp")) {
org.eclipse.jface.viewers.TableViewer.$TableViewer$TableColorAndFontNoOp$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.TableViewer.TableColorAndFontCollector")) {
org.eclipse.jface.viewers.TableViewer.$TableViewer$TableColorAndFontCollector$ ();
}
...
tableControl.addMouseListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TableViewer$1") ? 0 : org.eclipse.jface.viewers.TableViewer.$TableViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableViewer$1, this, null)));
}, "$wt.widgets.Control");
...
($fz = function () {
this.tableViewerImpl = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.TableViewer$2") ? 0 : org.eclipse.jface.viewers.TableViewer.$TableViewer$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableViewer$2, this, null, this));
...
function (elements) {
this.assertElementsNotNull (elements);
this.preservingSelection (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TableViewer$3") ? 0 : org.eclipse.jface.viewers.TableViewer.$TableViewer$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableViewer$3, this, Clazz.cloneFinals ("elements", elements))));
}, "~A");
Clazz.defineMethod (c$, "remove", 
function (element) {
this.remove ([element]);
...
c$.$TableViewer$VirtualManager$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
($fz = function () {
this.b$["org.eclipse.jface.viewers.TableViewer"].table.addListener (36, ((Clazz.isClassDefined ("org.eclipse.jface.viewers.TableViewer$VirtualManager$1") ? 0 : org.eclipse.jface.viewers.TableViewer.VirtualManager.$TableViewer$VirtualManager$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableViewer$VirtualManager$1, this, null)));
}, $fz.isPrivate = true, $fz));
Clazz.defineMethod (c$, "resolveElement", 
function (index) {
var element = null;
if (index < this.cachedElements.length) element = this.cachedElements[index];
return element;
}, "~N");
Clazz.defineMethod (c$, "notVisibleAdded", 
function (element, index) {
var requiredCount = index + 1;
if (requiredCount > this.b$["org.eclipse.jface.viewers.TableViewer"].getTable ().getItemCount ()) {
this.b$["org.eclipse.jface.viewers.TableViewer"].getTable ().setItemCount (requiredCount);
var newCache =  new Array (requiredCount);
...
c$.$TableViewer$VirtualManager$1$ = function () {
Clazz.pu$h ();
...
function (event) {
var item = event.item;
var index = this.b$["org.eclipse.jface.viewers.TableViewer"].table.indexOf (item);
var element = this.b$["org.eclipse.jface.viewers.TableViewer.VirtualManager"].resolveElement (index);
if (element == null) {
var contentProvider = this.b$["org.eclipse.jface.viewers.TableViewer"].getContentProvider ();
if (Clazz.instanceOf (contentProvider, org.eclipse.jface.viewers.ILazyContentProvider)) {
(contentProvider).updateElement (index);
return ;
}}this.b$["org.eclipse.jface.viewers.TableViewer"].associate (element, item);
this.b$["org.eclipse.jface.viewers.TableViewer"].updateItem (item, element);
}, "$wt.widgets.Event");
c$ = Clazz.p0p ();
};
c$ = Clazz.p0p ();
};
c$.$TableViewer$TableColorAndFontNoOp$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
Clazz.instantialize (this, arguments);
...
function (tableItem, element, column) {
}, "$wt.widgets.TableItem,~O,~N");
c$ = Clazz.p0p ();
};
c$.$TableViewer$TableColorAndFontCollector$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
...
if (Clazz.instanceOf (provider, org.eclipse.jface.viewers.ITableFontProvider)) this.fontProvider = provider;
if (Clazz.instanceOf (provider, org.eclipse.jface.viewers.ITableColorProvider)) this.colorProvider = provider;
}, "org.eclipse.jface.viewers.IBaseLabelProvider");
...
}if (this.fontProvider != null) tableItem.setFont (column, this.fontProvider.getFont (element, column));
}, "$wt.widgets.TableItem,~O,~N");
c$ = Clazz.p0p ();
};
c$.$TableViewer$1$ = function () {
Clazz.pu$h ();

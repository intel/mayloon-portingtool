...
Clazz.load (["org.eclipse.jface.viewers.IInputSelectionProvider", "org.eclipse.jface.util.ListenerList"], "org.eclipse.jface.viewers.Viewer", ["org.eclipse.jface.util.SafeRunnable", "$wt.events.HelpListener"], function () {
...
this.helpListener = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.Viewer$1") ? 0 : org.eclipse.jface.viewers.Viewer.$Viewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.Viewer$1, this, null));
...
for (var i = 0; i < listeners.length; ++i) {
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.Viewer$2") ? 0 : org.eclipse.jface.viewers.Viewer.$Viewer$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.Viewer$2, this, Clazz.cloneFinals ("l", l, "event", event))));
}

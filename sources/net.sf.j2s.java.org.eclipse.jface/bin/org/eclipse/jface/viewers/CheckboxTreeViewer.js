...
Clazz.load (["org.eclipse.jface.viewers.ICheckable", "$.TreeViewer", "org.eclipse.jface.util.ListenerList"], "org.eclipse.jface.viewers.CheckboxTreeViewer", ["java.util.ArrayList", "org.eclipse.jface.util.SafeRunnable", "org.eclipse.jface.viewers.CheckStateChangedEvent", "$wt.widgets.Tree"], function () {
...
var l = array[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.CheckboxTreeViewer$1") ? 0 : org.eclipse.jface.viewers.CheckboxTreeViewer.$CheckboxTreeViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.CheckboxTreeViewer$1, this, Clazz.cloneFinals ("l", l, "event", event))));
}
...
c$.$CheckboxTreeViewer$1$ = function () {
Clazz.pu$h ();

...
Clazz.load (null, "org.eclipse.jface.viewers.deferred.LazySortedCollection", ["java.lang.InterruptedException", "org.eclipse.jface.viewers.deferred.FastProgressReporter", "$.IntHashMap"], function () {
...
org.eclipse.jface.viewers.deferred.LazySortedCollection.$LazySortedCollection$Edge$ ();
}
...
this.lazyRemovalFlag = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.deferred.LazySortedCollection$1") ? 0 : org.eclipse.jface.viewers.deferred.LazySortedCollection.$LazySortedCollection$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.deferred.LazySortedCollection$1, this, null));
});
...
c$.$LazySortedCollection$Edge$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
($fz = function (newNode) {
if (this.direction == 0) {
this.b$["org.eclipse.jface.viewers.deferred.LazySortedCollection"].leftSubTree[this.startNode] = newNode;
} else if (this.direction == 1) {
this.b$["org.eclipse.jface.viewers.deferred.LazySortedCollection"].rightSubTree[this.startNode] = newNode;
} else if (this.direction == 2) {
this.b$["org.eclipse.jface.viewers.deferred.LazySortedCollection"].nextUnsorted[this.startNode] = newNode;
} else if (this.direction == 3) {
this.b$["org.eclipse.jface.viewers.deferred.LazySortedCollection"].root = newNode;
} else if (this.direction == 4) {
this.b$["org.eclipse.jface.viewers.deferred.LazySortedCollection"].firstUnusedNode = newNode;
}if (newNode != -1) {
this.b$["org.eclipse.jface.viewers.deferred.LazySortedCollection"].parentTree[newNode] = this.startNode;
}}, $fz.isPrivate = true, $fz), "~N");
...
c$.$LazySortedCollection$1$ = function () {
Clazz.pu$h ();

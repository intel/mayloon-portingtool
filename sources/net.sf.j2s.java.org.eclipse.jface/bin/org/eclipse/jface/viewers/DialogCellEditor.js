...
org.eclipse.jface.viewers.DialogCellEditor.$DialogCellEditor$DialogCellLayout$ ();
}
...
this.button.addKeyListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.DialogCellEditor$1") ? 0 : org.eclipse.jface.viewers.DialogCellEditor.$DialogCellEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.DialogCellEditor$1, this, null)));
this.button.addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.DialogCellEditor$2") ? 0 : org.eclipse.jface.viewers.DialogCellEditor.$DialogCellEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.DialogCellEditor$2, this, null)));
...
c$.$DialogCellEditor$DialogCellLayout$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
var size = this.b$["org.eclipse.jface.viewers.DialogCellEditor"].button.computeSize (-1, -1, force);
if (this.b$["org.eclipse.jface.viewers.DialogCellEditor"].contents != null) this.b$["org.eclipse.jface.viewers.DialogCellEditor"].contents.setBounds (0, 0, bounds.width - size.x, bounds.height);
this.b$["org.eclipse.jface.viewers.DialogCellEditor"].button.setBounds (bounds.width - size.x, 0, size.x, bounds.height);
...
var contentsSize = this.b$["org.eclipse.jface.viewers.DialogCellEditor"].contents.computeSize (-1, -1, force);
var buttonSize = this.b$["org.eclipse.jface.viewers.DialogCellEditor"].button.computeSize (-1, -1, force);
var result =  new $wt.graphics.Point (buttonSize.x, Math.max (contentsSize.y, buttonSize.y));
return result;
}, "$wt.widgets.Composite,~N,~N,~B");
c$ = Clazz.p0p ();
};
c$.$DialogCellEditor$1$ = function () {
Clazz.pu$h ();

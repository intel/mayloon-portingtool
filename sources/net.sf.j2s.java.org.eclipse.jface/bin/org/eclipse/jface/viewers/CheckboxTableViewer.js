...
Clazz.load (["org.eclipse.jface.viewers.ICheckable", "$.TableViewer", "org.eclipse.jface.util.ListenerList"], "org.eclipse.jface.viewers.CheckboxTableViewer", ["java.util.ArrayList", "org.eclipse.jface.util.SafeRunnable", "org.eclipse.jface.viewers.CheckStateChangedEvent", "$.ColumnWeightData", "$.TableLayout", "$wt.widgets.Table", "$.TableColumn"], function () {
...
var l = array[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.CheckboxTableViewer$1") ? 0 : org.eclipse.jface.viewers.CheckboxTableViewer.$CheckboxTableViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.CheckboxTableViewer$1, this, Clazz.cloneFinals ("l", l, "event", event))));
}
...
c$.$CheckboxTableViewer$1$ = function () {
Clazz.pu$h ();

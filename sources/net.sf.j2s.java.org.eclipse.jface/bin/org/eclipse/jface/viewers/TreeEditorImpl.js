...
this.focusListener = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.TreeEditorImpl$1") ? 0 : org.eclipse.jface.viewers.TreeEditorImpl.$TreeEditorImpl$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TreeEditorImpl$1, this, null));
}control.addFocusListener (this.focusListener);
this.mouseListener = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.TreeEditorImpl$2") ? 0 : org.eclipse.jface.viewers.TreeEditorImpl.$TreeEditorImpl$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TreeEditorImpl$2, this, Clazz.cloneFinals ("control", control)));
...
($fz = function () {
this.cellEditorListener = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.TreeEditorImpl$3") ? 0 : org.eclipse.jface.viewers.TreeEditorImpl.$TreeEditorImpl$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TreeEditorImpl$3, this, null));
}, $fz.isPrivate = true, $fz));

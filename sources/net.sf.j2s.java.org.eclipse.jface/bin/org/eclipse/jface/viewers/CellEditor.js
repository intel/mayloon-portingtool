...
Clazz.load (["org.eclipse.jface.util.ListenerList"], "org.eclipse.jface.viewers.CellEditor", ["org.eclipse.jface.util.PropertyChangeEvent", "$.SafeRunnable"], function () {
...
var l = array[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.CellEditor$1") ? 0 : org.eclipse.jface.viewers.CellEditor.$CellEditor$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.CellEditor$1, this, Clazz.cloneFinals ("l", l))));
}
});
...
for (var i = 0; i < array.length; i++) {
var l = array[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.CellEditor$2") ? 0 : org.eclipse.jface.viewers.CellEditor.$CellEditor$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.CellEditor$2, this, Clazz.cloneFinals ("l", l))));
}
});
...
for (var i = 0; i < array.length; i++) {
var l = array[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.CellEditor$3") ? 0 : org.eclipse.jface.viewers.CellEditor.$CellEditor$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.CellEditor$3, this, Clazz.cloneFinals ("l", l, "oldValidState", oldValidState, "newValidState", newValidState))));
}
}, "~B,~B");
...
for (var i = 0; i < array.length; i++) {
var l = array[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.CellEditor$4") ? 0 : org.eclipse.jface.viewers.CellEditor.$CellEditor$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.CellEditor$4, this, Clazz.cloneFinals ("l", l, "actionId", actionId))));
}
}, "~S");

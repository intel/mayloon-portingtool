...
Clazz.load (["org.eclipse.jface.viewers.AbstractTreeViewer", "$.TableEditorImpl"], "org.eclipse.jface.viewers.TableTreeViewer", ["org.eclipse.jface.viewers.DoubleClickEvent", "$.OpenEvent", "$.ViewerLabel", "$wt.custom.TableTree", "$.TableTreeEditor", "$.TableTreeItem", "$wt.events.MouseAdapter", "$wt.graphics.Point"], function () {
...
org.eclipse.jface.viewers.TableTreeViewer.$TableTreeViewer$TableTreeViewerImpl$ ();
}
...
this.tableTree.getTable ().addMouseListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TableTreeViewer$1") ? 0 : org.eclipse.jface.viewers.TableTreeViewer.$TableTreeViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TableTreeViewer$1, this, null)));
}, "$wt.widgets.Control");
...
c$.$TableTreeViewer$TableTreeViewerImpl$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
this.b$["org.eclipse.jface.viewers.TableTreeViewer"].tableTreeEditor.setEditor (w, item, columnNumber);
}, "$wt.widgets.Control,$wt.widgets.Item,~N");
Clazz.overrideMethod (c$, "setSelection", 
function (selection, b) {
this.b$["org.eclipse.jface.viewers.TableTreeViewer"].setSelection (selection, b);
...
function (layoutData) {
this.b$["org.eclipse.jface.viewers.TableTreeViewer"].tableTreeEditor.horizontalAlignment = layoutData.horizontalAlignment;
this.b$["org.eclipse.jface.viewers.TableTreeViewer"].tableTreeEditor.grabHorizontal = layoutData.grabHorizontal;
this.b$["org.eclipse.jface.viewers.TableTreeViewer"].tableTreeEditor.minimumWidth = layoutData.minimumWidth;
}, "org.eclipse.jface.viewers.CellEditor.LayoutData");
Clazz.overrideMethod (c$, "handleDoubleClickEvent", 
function () {
var viewer = this.getViewer ();
this.b$["org.eclipse.jface.viewers.TableTreeViewer"].fireDoubleClick ( new org.eclipse.jface.viewers.DoubleClickEvent (viewer, viewer.getSelection ()));
this.b$["org.eclipse.jface.viewers.TableTreeViewer"].fireOpen ( new org.eclipse.jface.viewers.OpenEvent (viewer, viewer.getSelection ()));
});
c$ = Clazz.p0p ();
};
c$.$TableTreeViewer$1$ = function () {
Clazz.pu$h ();

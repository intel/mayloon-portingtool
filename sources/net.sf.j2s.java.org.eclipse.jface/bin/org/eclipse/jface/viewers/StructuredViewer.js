...
Clazz.load (["org.eclipse.jface.util.SafeRunnable", "org.eclipse.jface.viewers.ContentViewer", "$.IPostSelectionProvider", "org.eclipse.jface.util.ListenerList"], "org.eclipse.jface.viewers.StructuredViewer", ["java.util.ArrayList", "org.eclipse.jface.util.IOpenEventListener", "$.OpenStrategy", "org.eclipse.jface.viewers.CustomHashtable", "$.DoubleClickEvent", "$.OpenEvent", "$.SelectionChangedEvent", "$.StructuredSelection", "$wt.dnd.DragSource", "$.DropTarget", "$wt.events.SelectionAdapter", "$.SelectionListener"], function () {
...
org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$ColorAndFontCollector$ ();
}
...
org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$ColorAndFontCollectorWithProviders$ ();
}
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer.UpdateItemSafeRunnable")) {
org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$UpdateItemSafeRunnable$ ();
}
...
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$1") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$1, this, Clazz.cloneFinals ("l", l, "event", event))));
}
...
for (var i = 0; i < listeners.length; ++i) {
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$2") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$2, this, Clazz.cloneFinals ("l", l, "event", event))));
}
...
for (var i = 0; i < listeners.length; ++i) {
var l = listeners[i];
org.eclipse.jface.util.SafeRunnable.run (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$3") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$3$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$3, this, Clazz.cloneFinals ("l", l, "event", event))));
}
...
handler.addSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$4") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$4$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$4, this, null)));
handler.addPostSelectionListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$5") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$5$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$5, this, null)));
handler.addOpenListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$6") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$6$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$6, this, null)));
}, "$wt.widgets.Control");
...
Clazz.defineMethod (c$, "refresh", 
function (element) {
this.preservingSelection (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$7") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$7$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$7, this, Clazz.cloneFinals ("element", element))));
}, "~O");
Clazz.defineMethod (c$, "refresh", 
function (element, updateLabels) {
this.preservingSelection (((Clazz.isClassDefined ("org.eclipse.jface.viewers.StructuredViewer$8") ? 0 : org.eclipse.jface.viewers.StructuredViewer.$StructuredViewer$8$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.StructuredViewer$8, this, Clazz.cloneFinals ("element", element, "updateLabels", updateLabels))));
}, "~O,~B");
...
c$.$StructuredViewer$ColorAndFontCollector$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
if (this.background != null) control.setBackground (this.background);
if (this.foreground != null) control.setForeground (this.foreground);
if (this.font != null) control.setFont (this.font);
}this.clear ();
...
c$.$StructuredViewer$ColorAndFontCollectorWithProviders$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
...
if (Clazz.instanceOf (provider, org.eclipse.jface.viewers.IColorProvider)) this.colorProvider = provider;
if (Clazz.instanceOf (provider, org.eclipse.jface.viewers.IFontProvider)) this.fontProvider = provider;
}, "org.eclipse.jface.viewers.IBaseLabelProvider");
Clazz.overrideMethod (c$, "setFontsAndColors", 
function (element) {
if (this.fontProvider != null) {
if (this.font == null) this.font = this.fontProvider.getFont (element);
}if (this.colorProvider == null) return ;
if (this.background == null) this.background = this.colorProvider.getBackground (element);
if (this.foreground == null) this.foreground = this.colorProvider.getForeground (element);
}, "~O");
Clazz.defineMethod (c$, "applyFontsAndColors", 
function (control) {
...
if (this.usedDecorators && this.font != null) control.setFont (this.font);
} else control.setFont (this.font);
this.clear ();
}, "$wt.widgets.TableItem");
Clazz.defineMethod (c$, "applyFontsAndColors", 
function (control) {
...
c$.$StructuredViewer$UpdateItemSafeRunnable$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
Clazz.prepareCallback (this, arguments);
this.widget = null;

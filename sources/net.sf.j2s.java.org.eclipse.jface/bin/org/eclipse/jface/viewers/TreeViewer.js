...
Clazz.load (["org.eclipse.jface.viewers.AbstractTreeViewer"], "org.eclipse.jface.viewers.TreeViewer", ["org.eclipse.jface.viewers.DoubleClickEvent", "$.OpenEvent", "$.TreeEditorImpl", "$.ViewerLabel", "$wt.custom.TreeEditor", "$wt.events.MouseAdapter", "$wt.graphics.Point", "$wt.widgets.Tree", "$.TreeItem"], function () {
c$ = Clazz.decorateAsClass (function () {
if (!Clazz.isClassDefined ("org.eclipse.jface.viewers.TreeViewer.TreeColorAndFontCollector")) {
org.eclipse.jface.viewers.TreeViewer.$TreeViewer$TreeColorAndFontCollector$ ();
}
...
treeControl.addMouseListener (((Clazz.isClassDefined ("org.eclipse.jface.viewers.TreeViewer$1") ? 0 : org.eclipse.jface.viewers.TreeViewer.$TreeViewer$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TreeViewer$1, this, null)));
}, "$wt.widgets.Control");
Clazz.defineMethod (c$, "initTreeViewerImpl", 
($fz = function () {
this.treeViewerImpl = ((Clazz.isClassDefined ("org.eclipse.jface.viewers.TreeViewer$2") ? 0 : org.eclipse.jface.viewers.TreeViewer.$TreeViewer$2$ ()), Clazz.innerTypeInstance (org.eclipse.jface.viewers.TreeViewer$2, this, null, this));
...
c$.$TreeViewer$TreeColorAndFontCollector$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
function (treeItem, element, column) {
...
}if (this.fontProvider != null) treeItem.setFont (column, this.fontProvider.getFont (element, column));
}, "$wt.widgets.TreeItem,~O,~N");
c$ = Clazz.p0p ();
};
c$.$TreeViewer$1$ = function () {
Clazz.pu$h ();

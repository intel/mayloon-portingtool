...
org.eclipse.jface.dialogs.ProgressMonitorDialog.$ProgressMonitorDialog$ProgressMonitor$ ();
}
...
this.getShell ().getDisplay ().asyncExec (((Clazz.isClassDefined ("org.eclipse.jface.dialogs.ProgressMonitorDialog$1") ? 0 : org.eclipse.jface.dialogs.ProgressMonitorDialog.$ProgressMonitorDialog$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.dialogs.ProgressMonitorDialog$1, this, Clazz.cloneFinals ("b", b))));
...
c$.$ProgressMonitorDialog$ProgressMonitor$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
if (name == null) this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].task = "";
 else this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].task = name;
var s = this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].task;
if (s.length <= 0) s = org.eclipse.jface.dialogs.ProgressMonitorDialog.DEFAULT_TASKNAME;
this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].setMessage (s);
...
this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].progressIndicator.beginTask (totalWork);
}}, "~S,~N");
...
if (name == null) this.fSubTask = "";
 else this.fSubTask = name;
...
function (work) {
if (!this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].progressIndicator.isDisposed ()) this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].progressIndicator.worked (work);
}, "~N");
...
function (reason) {
this.locked = true;
this.b$["org.eclipse.jface.dialogs.ProgressMonitorDialog"].updateForSetBlocked (reason);
}, "org.eclipse.core.runtime.IStatus");
c$ = Clazz.p0p ();
};
c$.$ProgressMonitorDialog$1$ = function () {
Clazz.pu$h ();

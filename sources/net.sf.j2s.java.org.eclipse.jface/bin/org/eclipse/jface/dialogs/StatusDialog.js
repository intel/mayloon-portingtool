...
org.eclipse.jface.dialogs.StatusDialog.$StatusDialog$MessageLine$ ();
}
...
c$.$StatusDialog$MessageLine$ = function () {
Clazz.pu$h ();
c$ = Clazz.decorateAsClass (function () {
...
Clazz.makeConstructor (c$, 
function (parent) {
this.construct (parent, 16384);
}, "$wt.widgets.Composite");
Clazz.makeConstructor (c$, 
function (parent, style) {
Clazz.superConstructor (this, org.eclipse.jface.dialogs.StatusDialog.MessageLine, [parent, style]);

...
Clazz.load (["java.lang.Thread"], "org.eclipse.jface.operation.ModalContext", ["java.lang.InterruptedException", "java.lang.reflect.InvocationTargetException", "org.eclipse.jface.operation.AccumulatingProgressMonitor", "$wt.widgets.Display"], function () {
...
($fz = function (operation, monitor, display) {
...
this.progressMonitor =  new org.eclipse.jface.operation.AccumulatingProgressMonitor (monitor, display);
...
this.display.syncExec (((Clazz.isClassDefined ("org.eclipse.jface.operation.ModalContext$ModalContextThread$1") ? 0 : org.eclipse.jface.operation.ModalContext.ModalContextThread.$ModalContext$ModalContextThread$1$ ()), Clazz.innerTypeInstance (org.eclipse.jface.operation.ModalContext$ModalContextThread$1, this, null)));
...
c$.$ModalContext$ModalContextThread$1$ = function () {
Clazz.pu$h ();

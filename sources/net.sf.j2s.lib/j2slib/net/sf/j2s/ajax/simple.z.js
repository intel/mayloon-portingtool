...
$_J("net.sf.j2s.ajax");
$_L(null,"net.sf.j2s.ajax.SimpleRPCRequest",["java.net.URLEncoder","net.sf.j2s.ajax.XHRCallbackAdapter"],function(){
...
c$.getRequest=$_M(c$,"getRequest",
function(){
return new net.sf.j2s.ajax.HttpRequest();
});
...
if(url2!==url){
serialize=null;
}var request=net.sf.j2s.ajax.SimpleRPCRequest.getRequest();
...
$_I(net.sf.j2s.ajax.SimpleRPCRequest,"IHttpRequestFactory");
$_S(c$,
"MODE_AJAX",1,
...
$_J("net.sf.j2s.ajax");
$_L(["net.sf.j2s.ajax.SimpleRPCRequest"],"net.sf.j2s.ajax.SimpleRPCSWTRequest",["net.sf.j2s.ajax.XHRCallbackSWTAdapter"],function(){
...
function(pipeKey,pipeRequestType){
...
return"k"+"="+pipeKey+"&"+"t"+"="+pipeRequestType+"&"+"r"+"="+net.sf.j2s.ajax.SimplePipeRequest.reqCount;
},"~S,~S");
...
var requestURL=url+(url.indexOf('?')!=-1?"&":"?")+net.sf.j2s.ajax.SimplePipeRequest.constructRequest(runnable.pipeKey,"x");
...
function(runnable){
var url=runnable.getPipeURL();
net.sf.j2s.ajax.SimplePipeRequest.loadPipeScript(url+(url.indexOf('?')!=-1?"&":"?")+net.sf.j2s.ajax.SimplePipeRequest.constructRequest(runnable.pipeKey,"n"));
},"net.sf.j2s.ajax.SimplePipeRunnable");
...
function(runnable){
var pipeRequest=net.sf.j2s.ajax.SimpleRPCRequest.getRequest();
var pipeKey=runnable.pipeKey;
...
var pipeRequestData=net.sf.j2s.ajax.SimplePipeRequest.constructRequest(pipeKey,"q");
var async=false;
async=true;
...
c$.getRequestWithMonitor=$_M(c$,"getRequestWithMonitor",
function(montior){
return(($_D("net.sf.j2s.ajax.SimplePipeRequest$5")?0:net.sf.j2s.ajax.SimplePipeRequest.$SimplePipeRequest$5$()),$_N(net.sf.j2s.ajax.SimplePipeRequest$5,this,$_F("montior",montior)));
},"net.sf.j2s.ajax.HttpRequest.IXHRReceiving");
...
}}ss=net.sf.j2s.ajax.SimpleSerializable.parseInstance(string,end);
if(ss==null||!ss.deserialize(string,end)){
break;
}if(ss!==net.sf.j2s.ajax.SimpleSerializable.UNKNOWN){
var key=string.substring(start,end);
var runnable=net.sf.j2s.ajax.SimplePipeHelper.getPipe(key);
if(runnable!=null){
runnable.lastPipeDataReceived=System.currentTimeMillis();
...
c$.$SimplePipeRequest$5$=function(){
$_H();
c$=$_W(net.sf.j2s.ajax,"SimplePipeRequest$5",net.sf.j2s.ajax.HttpRequest);
$_V(c$,"initializeReceivingMonitor",
function(){
return this.f$.montior;
});
c$=$_P();
};
$_I(net.sf.j2s.ajax.SimplePipeRequest,"IHttpPipeRequestFactory",net.sf.j2s.ajax.SimpleRPCRequest.IHttpRequestFactory);
$_S(c$,
"PIPE_STATUS_OK","o",

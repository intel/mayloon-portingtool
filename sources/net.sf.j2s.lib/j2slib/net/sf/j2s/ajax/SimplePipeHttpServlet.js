...
if(net.sf.j2s.ajax.SimplePipeHelper.getPipeDataList(key)!=null&&(this.pipeMaxItemsPerQuery<=0||items<this.pipeMaxItemsPerQuery||isContinuum)&&(isContinuum||(isScripting&&now-beforeLoop<this.pipeScriptBreakout)||(priority<32&&now-beforeLoop<this.pipeQueryTimeout))){
{
try{
pipe.wait(1000);
}catch(e){

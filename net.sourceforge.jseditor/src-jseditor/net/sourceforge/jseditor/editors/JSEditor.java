...
//		}
	 ...
	 */
	/***
	 * in getAdapter()，we connect the jseditor with the outline view
	 * in getAdapter() ，when the parameter is IContentOutlinePage ，
	 * it means Outline view search jsEditor for pages ，when return is not null，the outline view will show the result
	 */
                  ...
                  // outline page will be notified about changes of the caret position
                     ...
                     outlinePage.addSelectionChangedListener(new ISelectionChangedListener(){
						...
						public void selectionChanged(SelectionChangedEvent event) {
							  ...
							  //it leads to dead cycle if setHighlightRange()and selectAndReveal()
							  //be  used together
				                        ...
				                        try {
				        					...
				        					else if (text.startsWith("load"))
				        					{
				        						...
				        						getSourceViewer().setSelectedRange(x, y);}
				        							 ...
				        							 setHighlightRange(region.getOffset(), 10,true);
	...
	private void clickOutline(int offset,String tag1,String tag2,String text){
		...
		setHighlightRange(x, y,true);
		getSourceViewer().setSelectedRange(x, y);}
		else setHighlightRange(offset, 10,true);
    }
